...
positive (2009) to null (2015) to interactive (2023), consistent with proxy
obsolescence rather than stable digital-capability moderation.
\end{quote}
...
World Bank Enterprise Surveys (WBES): Vietnam 2009 (\(n = 1{,}074\)), 2015
(\(n = 1{,}001\)), 2023 (\(n = 883\)); pooled \(N = 2{,}958\).  All monetary
values converted to 2017 constant USD PPP.
...
foreign-licensed technology (\texttt{b7}):
\begin{equation}
...
2009 = 39.3\%, 2015 = 45.1\%, 2023 = 46.2\%, pooled = 39.7\%.
...
proxy-obsolescence arc rather than indicating dynamic digital capability.
