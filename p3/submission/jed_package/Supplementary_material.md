...
## S3. Pooled marginal effects of internationalisation (referenced in Section 4.2)
...
## S4. Wave-specific predicted-productivity figures (Figures 2a–2d, referenced in Section 4.2)
...
## S5. Full robustness analyses (Panels A–K, referenced in Section 4.5)
