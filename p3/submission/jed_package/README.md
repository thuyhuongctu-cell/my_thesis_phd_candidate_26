...
- Supply high-resolution figure files (.tif/.eps/.jpeg) at submission.
- Apply Word heading styles (L1 bold, sub-headings italic) if desired (cosmetic).
- This package is **not** auto-submitted; the corresponding author uploads via Emerald/ScholarOne.
