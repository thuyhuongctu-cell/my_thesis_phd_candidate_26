...
|------|-------------|------------|
| `01_manuscript_blinded.docx` | Main manuscript — author information removed for double-blind review | Manuscript (blinded) |
| `02_title_page.docx` | Title page with full author details, CRediT, acknowledgements, data availability | Title page (separate upload) |
| `03_cover_letter.docx` | Cover letter to Editor-in-Chief | Cover letter |
| `figures/figure_1_conceptual_model.png` | Conceptual model diagram (300 DPI PNG) | Figure 1 |
| `figures/figure_2a.png` | Wave 2009 predicted ln(LP) vs FSTS curve | Figure 2a |
| `figures/figure_2b.png` | Wave 2015 predicted ln(LP) vs FSTS curve | Figure 2b |
| `figures/figure_2c.png` | Wave 2023 predicted ln(LP) vs FSTS curve | Figure 2c |
| `figures/figure_2d.png` | Pooled (2009+2015+2023) predicted ln(LP) vs FSTS curve | Figure 2d |
| `figures/figure_3_moderator_marginals.png` | TCI and DAI moderator marginal effects | Figure 3 |
...
| Figures | 6 |
| References | 48 |
| Data source | WBES Vietnam 2009, 2015, 2023 (N = 2,958) |
