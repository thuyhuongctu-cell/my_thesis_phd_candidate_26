...
|---|---|---|
| **A1** | P9 cover kể chuyện durability ngược kết quả + "under review" sai + 22,000 obs | ✅ **SỬA** — "dissolves rather than relocates"; "in preparation"; 28,717 |
| **A2** | P6 ICR thì quá khứ cho việc chưa làm | ✅ **SỬA** — chuyển present-tense protocol (4 package) |
| **A3** | P6 "third reviewer / two screeners" không tồn tại | ✅ **SỬA** — "two authors… resolved by discussion" (4 package + OSF) |
| **A4** | OSF template còn census + third reviewer | ✅ **SỬA** — reframe citation-anchored + 2 tác giả |
| **B1** | Bản dịch VI lệch pha (P9 28.742, P5 217-panel, P6 90/78) | ✅ **SỬA** — đồng bộ với EN |
| **B2** | P8 Conclusion thiếu caveat N=209 | ✅ **SỬA** — thêm estimation N=209 (3 package) |
| **B3** | P8 Bảng 1 "N (firms)" vs firm-year obs | ✅ **SỬA** — ghi rõ "firm-year observations" |
| **B4** | P9 MIR abstract structured (sai chuẩn Springer) | ✅ **SỬA** — chuyển unstructured 236 từ (IJOEM/JABS giữ 7-part) |
| **B5** | P4 N=84 chỉ làm rõ ở mbr | ✅ **SỬA** — thêm vào mir + apbr |
