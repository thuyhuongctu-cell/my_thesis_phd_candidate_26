...
|---|---|:--:|:--:|:--:|:--:|---|
| P3 Vietnam | JED | 3 to 0* | 6 | 6 | 7.0 | 1–2 days |
| P4 Singapore | MBR | 0 | 6 | 7 | 7.0 | minor–moderate |
| P5 China | IJOEM | 0 | 5 | 9 | 7.5 | minor |
| P6 Meta | JIM | 1 to 0* | 5 | 7 | 7.0 | minor–moderate |
...
1. **P6 (CRITICAL):** jim package header + Figure-1 note named the wrong journal (International Business Review) to corrected to **Journal of International Management (JIM)**.
...
4. **All papers:** spaced thousands separators ("2, 610" to "2,610") fixed in 6 manuscripts (P5: 42, P7: 29, P6: 8, P3/P4/P8: 5 each).
...
- **P4:** turning point 82% (Section 4.2) vs 88.6% (elsewhere); M8 interaction −1.177 (text) vs −1.167 (Table 2).
- **P5:** Section 3.3 claims a 217-firm cross-wave "panel core" but Section 5.4 says WBES anonymisation makes panel matching impossible — resolve the contradiction. Cover letter mis-frames the full private-firm sample as "manufacturing". Package metadata (table count 3 vs 4; word count; JEL/keywords) disagrees with the manuscript.
- **P7:** M10 in-text coefficients (+0.763/+1.762/−2.746) contradict Table 3 (+0.729/+1.636/−2.501); abstract advertises H1–H4 but body tests H1–H6; stray "34 economies" vs the 49-economy framing; "HongKong" to "Hong Kong"; DAI premium 16% vs 17%.
...
- **P9:** pooled N 28,717 vs 28,742 (Section 4.4); structured abstract ~600 words vs the ≤250 claim (condense); "three contributions / H1–H3" framing mislabels the actual H1 / H2a-b / H3a-b / H4a-b set.
...
### House-style polish
- **Harvard "&" to "and"** in narrative citations (Emerald packages P4, P5).
...
## Bottom line
The seven papers are **scientifically sound and structurally complete**; remaining work is **revision hygiene** (number reconciliation, reference completeness, P8 estimation-N transparency). No paper needs a major rewrite. Recommended order: P8 (estimation-N + Table 1) to number reconciliations to reference lists to house-style polish.
