...
|---|---|---|---|
| Pool phân loại ICRV (52 nền) | 96.415 dòng | "≈ 96.415" | Có exact |
| Mẫu hồi quy chính (49 nền Á–TBD) | ~91.864 dòng | "N = 91.982 từ 49 nền" | Có (lệch 118 ≈ 0,1%) |
...
Phá regime dưới khung 49: Advanced_innovation **5** (bỏ Cyprus) · Advanced_resource 6 · Emerging 17 · Lower_mid 7 · SIDS **8** (bỏ Comoros) · Upper_mid **6** (bỏ Turkey) = **49**.
 ...
 đến **KHÔNG phải lỗi.** File dữ liệu chứa 3 nền ngoài châu Á + 3 bản `_panel` là **nguồn rộng hợp lệ**; luận án chỉ phân tích 49 nền Á–TBD. Comoros/Turkey/Cyprus **không được nêu tên** trong bất kỳ chương nào đến nhất quán.
...
- đến Dòng bảng Ch2 *"P8 — SIDS (9 nền kinh tế, Nhóm VI)"* gán 9 cho P8 dễ gây hiểu nhầm: P8 **chính** phân tích 7 Pacific. **Đề nghị** sửa nhãn thành "Nhóm VI SIDS (regime 9 nền; P8 phân tích 7 nước Pacific, N=959)".
...
- **CĐ1 có sẵn ghi chú dữ liệu (dòng 41)** đối chiếu minh bạch: 47 nền/101.185 (bản khóa CĐ1) ↔ 49 nền/91.982 (luận án, sau dedup panel + chuẩn hóa lại); SIDS biên = 7 nước Pacific. đến committee đọc cả hai sẽ thấy lý do khác biệt.
...
|---|---|---|
| M1 | Mâu thuẫn số liệu (47/49, SIDS, N, k) | Có Đã sửa; B1 (49-vs-52) GIẢI QUYẾT (Á–TBD); chỉ còn C (CĐ1) |
| M2 | Bản 5 chương thiếu front matter | Có Đầy đủ: Cam đoan/Tóm tắt/Abstract/Mục lục/Từ viết tắt/DM Bảng/DM Hình/DM công trình NCS (`00_phan_dau_vi.md`) |
| M3 | Thiếu hình mô hình khái niệm | Có Fig 2.1 CDCM có trong Mục 2.5.1, kèm caption đầy đủ |
| M4 | TLTK chưa hợp nhất | Có `04_references_apa7.md` hợp nhất ~271 entry APA7 |
| M5 | Hệ giả thuyết rò mã chưa định nghĩa | Có H1–H6/H1b + H2b/H4a-b/E1a-b định nghĩa ở Ch2 Mục 2.5 (ghi chú ký hiệu) |

 đến Luận án đã từ **MAJOR REVISION** tiến tới **gần sẵn sàng**; B1+B2+C đã đóng về mặt **số liệu**. Việc còn lại chỉ là chất lượng học thuật CĐ1 (~65%) và khe lệch 118 dòng (nhỏ, build script).
