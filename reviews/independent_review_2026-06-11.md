...
|---|---|---|---|
| **Logic học thuật & mạch lập luận** | 8,5/10 | MINOR (một chỗ MAJOR) | Mạch gap→RQ→H→method→result→conclusion rất chặt; H1–H6 + H1b + (H1c Ấn Độ) ánh xạ rõ. Lỗi: H1c (P9) xuất hiện ở Bảng 4.9 nhưng KHÔNG được phát biểu trong hệ giả thuyết Chương 2; "tăng đơn điệu" phân tán không khớp bảng. |
...
|---|---|---|---|---|
| I-01 | chuong_5_..._vi.md:51 | **Hệ số FIP P8 mâu thuẫn nội bộ**: §5.1.5 ghi `β = −0,404, p = ,032` trong khi Chương 3 (§3.4.5.5, dòng 455), Chương 4 (§4.7.2, dòng 223) và §5.6.1 (dòng 191) đều ghi `β(FSTS_c) = −1,339, p < ,001` (M1 country+year FE). −0,404 không xuất hiện ở bất kỳ bảng nào. | Thay `β = −0,404, p = ,032` bằng giá trị canonical `β = −1,339, p < ,001 (M1, country+year FE)` hoặc nêu rõ đây là spec nào (không có spec nào cho ra −0,404 trong Bảng độ vững §3.4.5.5). | **CRITICAL** |
| I-02 | chuong_5_..._vi.md:151 vs chuong_4_..._vi.md:225,217 | **N exporters-only SIDS không nhất quán**: §5.5.2 ghi "SIDS exporters-only N = 187"; §4.7.2 ghi "exporters-only, N = 26"; §4.7.1 ghi "N_exporters = 132 (13,8%)"; Bảng §3.4.5.5 ghi "Exporters-only (N = 26)". Ba con số 26/132/187 cho cùng một subset. | Thống nhất một định nghĩa: tổng số DN có FSTS>0 (=132) vs N đưa vào hồi quy exporters-only sau lọc missing (=26). Sửa §5.5.2 "187"→"26" (hoặc 132 nếu là nghĩa khác) và chú thích rõ chênh lệch do listwise deletion. | **CRITICAL** |
| I-03 | chuong_1_..._vi.md:57 vs 37,45,83,97; chuong_2:111 | **Số nền SIDS mâu thuẫn trong cùng Chương 1**: §1.5.2 (dòng 57) ghi SIDS gồm "**9 nền** kinh tế đảo nhỏ Thái Bình Dương"; nhưng §1.3, §1.4, §1.8.1, §1.9 (dòng 37,45,83,97) và P8 đều ghi "**7 nền** Pacific SIDS". Chương 2 (dòng 111) lại ghi "9 nền". | Chuẩn hóa: mẫu CHÍNH P8 = **7 nền Pacific**; robustness mở rộng = **9 nền** (thêm Comoros + Timor-Leste). Sửa §1.5.2 và §2.3.3 (dòng 111) thành "7 nền (mẫu chính); 9 nền (robustness)" để khớp Bảng 2.1 (dòng 208) đã ghi đúng. | **MAJOR** |
| I-04 | chuong_2_..._vi.md:137 | **Danh sách nước SIDS trong P8 thiếu/khác**: liệt kê "(Fiji, Tonga, Solomon Islands, Vanuatu, Samoa)" = 5 nước, trong khi §3.4.5.5 (dòng 424) liệt kê 7 nước (thêm Kiribati, Papua New Guinea). | Bổ sung đủ 7 nước Pacific cho khớp Chương 3, hoặc ghi rõ "ví dụ" nếu chỉ minh họa. Tránh liệt kê 5 nước khi mẫu là 7. | **MAJOR** |
...
| I-06 | chuong_4_..._vi.md:19 | **Khẳng định "tăng đơn điệu" không khớp chính Bảng 4.1**: dòng 19 nói sd log LP "tăng đơn điệu" từ thể chế cao→thấp; nhưng Bảng 4.1 cho I=1,03 < III=1,29 > IV=1,24 < V=1,36 > VI=1,32 — KHÔNG đơn điệu (III>IV, V>VI). Đây cũng là rủi ro "artifact" prompt cảnh báo: gradient phân tán không trơn. | Đổi "tăng đơn điệu" → "có xu hướng tăng (gần đơn điệu, với dao động giữa Nhóm III–IV và V–VI)". Tránh từ "đơn điệu" cho dữ liệu không đơn điệu. Lưu ý canonical: lp_z within-country-year sd ~đồng đều (0,92–1,00) → khi z-chuẩn hóa, gradient phân tán BIẾN MẤT; cần nói rõ Bảng 4.1 là sd của log LP đã winsorize/PPP (chưa z-within), nên gradient một phần phản ánh khác biệt mức giữa nước. | **MAJOR** |
| I-07 | chuong_4_..._vi.md:276 vs chuong_2 §2.5 | **H1c (Ấn Độ — tan biến ngưỡng) chưa có trong hệ giả thuyết Chương 2**: Bảng 4.9 (dòng 276) và §5.6.1 báo cáo "H1c" như một giả thuyết được xác nhận, nhưng Chương 2 chỉ phát biểu H1–H6 + H1b (không có H1c). Chương 1 (dòng 105) mô tả P9 là "phát hiện" chứ không phải giả thuyết tiền nghiệm. | Hoặc (a) bổ sung phát biểu H1c vào §2.5 như giả thuyết điều kiện biên thời gian; hoặc (b) đổi nhãn "H1c" thành "Phát hiện bổ sung P9 (post-hoc)" trong Bảng 4.9 để không tạo giả thuyết "ma" chưa khai báo. | **MAJOR** |
| I-08 | cd1/00_cd1_..._vi.md:99,113,122–126,205,210,274,377,843,859,1037,1047 | **CĐ1 chưa re-lock — dùng 101.185 DN / 47 nền / 108 cặp** xuyên suốt (abstract, mục tiêu, bảng, phụ lục), lệch canonical (analytic 91.982/49 nền; phân loại 96.415/52 nền). CANONICAL §2 liệt kê đây là số "lỗi cần chuẩn hóa". | Re-lock CĐ1 về bản canonical: pool phân loại 96.415/52 nền → khung phân tích 49 nền/91.982 (91.864). Ghi chú dòng 1049 đã thừa nhận "bản khóa CĐ1 = 101.185/47" — cần thực thi re-lock, không chỉ chú thích. | **CRITICAL** (cho CĐ1; nếu CĐ1 nộp riêng) / **MAJOR** (nếu chỉ là phụ lục lịch sử) |
...
| I-10 | chuong_3_..._vi.md:539 | **Bảng 3.6 ghi "47 châu Á + Pacific economies"** trong khi toàn bộ Chương 3 và luận án dùng "49 nền". Sót số cũ. | Sửa "47" → "49" ở dòng 539 (Mixed design row). | **MAJOR** (sai số rõ trong bảng tóm tắt) |
| I-11 | chuong_4_..._vi.md:138,303(ch3) | **Paternoster p-value gán nhầm vế**: §4.4.2 (dòng 138) chỉ báo cáo `z = +0,82, p = ,412` (vế FSTS) cho "điểm turning point ổn định". Anchor canonical cho P5 ghi `p = ,545` (đó là vế FSTS², z = −0,61, theo §3.4.5.3 dòng 303). Không sai, nhưng Chương 4 nên báo cáo CẢ HAI vế (FSTS p=,412 và FSTS² p=,545) để khớp anchor và đầy đủ. | Bổ sung vào §4.4.2: "z(FSTS²) = −0,61, p = ,545" bên cạnh z(FSTS). Hiện chỉ có ở Chương 3. | MINOR |
| I-12 | chuong_4_..._vi.md:30 vs chuong_1:57 | **Bảng 4.1 Nhóm VI phân loại n = 2.038**, nhưng canonical phân loại VI = 2.038 ✓ và analytic VI = 1.885. Nhất quán. Tuy nhiên SIDS trong Bảng 4.1 liệt kê "FJI, PNG, SLB..." (Pacific) trong khi nhóm phân loại 96.415 có thể gồm cả Timor/Comoros. | Thêm chú thích Bảng 4.1: nhóm VI phân loại gồm 8 nền (Pacific 7 + Timor-Leste); P8 phân tích 7 Pacific. (Liên kết I-09.) | MINOR |
| I-13 | chuong_2_..._vi.md:103,135; chuong_3:33 | **P6 mô tả "K=288 effect sizes / k=238" nhưng §4.2.1 (ch4:81) ghi "hàng trăm cặp effect-size đa dạng"** — mơ hồ, mất con số K=288. | Thay "hàng trăm cặp effect-size" bằng "K = 288 effect sizes" để nhất quán Chương 2/3. | MINOR |
...
| I-15 | chuong_4_..._vi.md:202,158; figures | **Nhãn hình "Hình 4.x"** (placeholder) chưa đánh số chính thức (xuất hiện 2 lần: dòng 112 "Hình 4.x", dòng 202–204). | Đổi "Hình 4.x" → số thứ tự chính thức (vd Hình 4.1, 4.2) trước bản nộp. | MINOR |
| I-16 | chuong_3_..._vi.md:193 | **Ghi chú M4 P3 ghi "(H4 thăm dò)"** nhưng M4 là điều tiết CSS/DAI (thuộc H3, không phải H4). Nhãn giả thuyết sai. | Sửa "(H4 thăm dò)" → "(H3 thăm dò)" cho M4 Việt Nam (DAI/CSS là H3). Kiểm tra dòng 219 cũng ghi "H4 thăm dò" cho CSS_z. | **MAJOR** (gán sai giả thuyết) |
...
4. **N = 84.910 của P7 dùng ĐÚNG ngữ cảnh**: luôn được mô tả là "N hồi quy M2/mô hình đầy đủ sau listwise", KHÔNG nhầm là pool (canonical §2 cảnh báo đúng điều này). §4.6.1 và §2.4 (dòng 135) đều ghi rõ "mẫu phân tích 91.982; N hồi quy mô hình đầy đủ = 84.910". Đúng.

5. **Mạch logic chương**: gap (§2.4) → RQ (§1.4) → H1–H6/H1b (§2.5) → method/model M0–M11 (§3.4) → results theo gradient ICRV (§4) → discussion CDCM (§5). Ánh xạ Bảng 2.1 (P↔chương↔H) rõ ràng. Thuật ngữ FSTS/LP/TCI/DAI/ICRV nhất quán.

6. **Thận trọng thống kê tốt**: Singapore TP=88,6% được hạ tông đúng (CI vượt 100%, power ~16%, "consistent but underpowered"); SIDS exporters-only NS được thừa nhận thiếu power; trim-and-fill r=0,074→0,035 báo cáo minh bạch.

### 3.2 CẦN SỬA (theo thứ tự ưu tiên)

- **CRITICAL (chặn bảo vệ)**: I-01 (FIP β=−0,404 sai), I-02 (N exporters-only 26/132/187), I-08 (CĐ1 re-lock 101.185/47→91.982/49) nếu CĐ1 nộp như phần độc lập.
...
- **Chương 1**: Bối cảnh→vấn đề→3 khoảng trống→mục tiêu→RQ→phạm vi→giả thuyết tóm tắt→đóng góp→tính mới→cấu trúc. Logic mạnh. Lỗi: SIDS 9 vs 7 nền (I-03); "Điểm mới thứ năm/thứ sáu" — đánh số "năm điểm mới" nhưng liệt kê SÁU (dòng 97: "năm điểm mới" rồi có "Điểm mới thứ sáu"). → MINOR đếm sai.
- **Chương 2**: Khái niệm→4 lý thuyết + digital lens→thực nghiệm 3 giai đoạn→meta→châu Á→gap→CDCM→H1–H6/H1b→Bảng ánh xạ. Rất chắc. Lỗi: danh sách SIDS 5 nước (I-04); thiếu H1c (I-07).
...
- **Chương 4**: §4.1 mô tả (xử lý artifact đúng) → §4.2 P6 meta → §4.3 SG → §4.4 CN → §4.5 VN → §4.6 P7 → §4.7 SIDS → §4.8 Ấn Độ → §4.9 tổng hợp H. Lỗi: "đơn điệu" (I-06); N exporters (I-02); H1c (I-07); "Hình 4.x" (I-15).
- **Chương 5**: Bàn luận CDCM→so sánh tiền nhân→đóng góp→chính sách→hạn chế→kết luận. Lỗi nghiêm trọng nhất: FIP β=−0,404 (I-01) và N=187 (I-02). Hai số này phá nhất quán với Chương 3/4. Ngoài ra §5.1.5 bị đánh số trùng (hai mục "5.1.5": FIP và Ấn Độ) — MINOR.
...
1. I-01: Sửa FIP β trong §5.1.5 về −1,339 (p<,001) — hoặc nêu rõ spec.
2. I-02: Thống nhất N exporters-only SIDS (26 vs 132 vs 187) với định nghĩa rõ.
3. I-08: Re-lock CĐ1 (101.185/47/108 → 96.415·52 / 91.982·49 / theo canonical).
4. I-03 & I-04: Chuẩn hóa SIDS = 7 nền Pacific (mẫu chính) / 9 nền (robustness); sửa danh sách 5-nước ở §2.3.3.
5. I-10: Sửa "47" → "49" trong Bảng 3.6.
6. I-16: Sửa nhãn M4 Việt Nam "H4" → "H3".
7. I-07: Khai báo H1c trong §2.5 hoặc đổi thành "phát hiện post-hoc P9".
8. I-05: Đối chiếu P5 N (4.544 vs 4.559).
9. I-06: Bỏ từ "đơn điệu" cho gradient phân tán không đơn điệu; làm rõ Bảng 4.1 là sd của log LP (chưa z-within) → tránh hiểu lầm artifact.
