...
| **Tổng** | 101.185 | 101.185 | (cùng tổng, khác hoàn toàn phá) |
 đến **Hai bảng cùng tả pool 101.185 nhưng phá theo nhóm hoàn toàn khác.** Bắt buộc thống nhất (Bảng A.1 dường như là bản nháp cũ — IV/V đảo ngược bất hợp lý: Frontier 53.200 > Emerging 21.000 mâu thuẫn mọi bảng khác).

### C2. Số nước "châu Á thuần": text ghi **41**, nhưng 5 nhóm chính cộng lại = **40**
Mục 2.1.2/2.1.3/2.1.5 nói "41 nước châu Á thuần". Nhưng I(5)+II(5)+III(6)+IV(7)+V(17) = **40**. Và 40+7 SIDS = 47 (khớp tổng). đến "**41**" sai, phải là **40**. (Nếu giữ 41 thì tổng thành 48 ≠ 47.)

### C3. SIDS có 3 con số khác nhau
- **1.371** (pool — Mục 2.1.3, 2.3.2, 2.3.7, Bảng 2.3.2.1) — khớp dữ liệu thật 7 Pacific.
- **1.097** (analytic sau lọc missing — Bảng 2.3.3.1, có giải thích) — OK.
- **2.385** (Bảng A.1 phụ lục) — **mâu thuẫn**, không giải thích được.
- Thêm: Mục 2.1.4(6) "9/~52 SIDS theo UNCTAD" — số "9" gây nhầm (CĐ1 dùng 7 Pacific xuyên suốt); làm rõ "9" là gì hoặc sửa.

### C4. Phá thế hệ schema có 2 bộ số, đều cộng = 101.185
- Mục 2.1.3: PICS3 **14.335** / Standardized **25.046** / BREADY **61.804**.
- Mục 2.2 + Hình 2.3.3.1 + Phụ lục: PICS3 **14.171** / Standardized **24.564** / BREADY **62.450**.
 đến Chọn 1 bộ chuẩn, sửa bộ kia.

### C5. Tổng Emerging: 47.803 (Bảng 2.3.6.4, đa số bảng) vs **42.278** (Mục 2.3.7.5 "Tổng hợp Emerging Asia n=42.278")
...
2. **(MAJOR)** Claim "loại ICT đến hệ số DAI −0,129 **biến mất**" (Mục 2.3.4.3) là trụ cột lập luận "Nghịch lý bão hòa số" nhưng **không có con số hậu-loại-trừ**. Cần báo cáo hệ số sau khi loại ICT (vd −0,129 đến −0,0xx, n.s.).
3. **(MINOR)** Phân tán analytic (Bảng 2.3.3.1): Frontier rớt 28.678 đến 18.877 (−35%) trong khi Emerging chỉ rớt 47.803 đến 45.388 (−5%). Chênh lệch tỷ lệ missing lớn bất thường — cần 1 câu giải thích (vì sao Frontier mất nhiều biến năng suất hơn).
...
1. **(MAJOR) Citation ≠ reference (lỗi APA7 hội đồng dễ bắt):**
   - Mục 2.3.1.3 trích "**Wu, Fan & Chen (2022)**" (meta-analysis) nhưng reference list chỉ có "**Wu, J., Li, S., & Selover, D. D. (2022)**" (FDI vs trade) — **khác tác giả, khác chủ đề**. Hoặc sai tên, hoặc thiếu 1 reference.
...
2. **(MINOR)** Contractor et al. (2003) trong reference list — kiểm tra có được trích in-text không (nếu không đến orphan reference, bỏ).
...
1. **(MINOR)** Singapore turning point mâu thuẫn: **~82%** (Mục 2.3.1.6, Bảng 2.3.2.2) vs **~88,6%** (Mục 2.3.7.1, KL1) — thống nhất (P4 dùng 88,6%).
...
3. **(MINOR)** Hàm ý chính sách (Mục 2.4.2) rất phong phú (8 điểm) nhưng một số đi xa khỏi "thực trạng" (vd PLMS/RSE lao động di chuyển) — cân nhắc gọn lại cho đúng phạm vi chuyên đề mô tả.

## 🟪 Devil's Advocate

1. **(MAJOR — phản biện lõi)** CĐ1 tuyên bố "**không thiết lập mô hình hồi quy nhân quả**" (Mục 2.2) nhưng lại dùng nhiều **claim nhân quả** mượn từ component study: "TCI=0,179 nhân quả IV" (Mục 2.4.2.1), "FSTS²×DAI=3,119 p=0,005" (Mục 2.3.1.6, 2.3.8.3). đến Phải **đóng khung nhất quán**: "theo nghiên cứu thành phần P3 Việt Nam / P4 Singapore" mỗi lần dùng, tránh người đọc hiểu CĐ1 tự ước lượng nhân quả.
...
> **Đã sửa độc lập-lock 2026-06-10 (không cần raw):** C1/C3 (Bảng A.1 đồng bộ thân bài Bảng 2.3.2.1: I 4.220/II 1.932/III 16.693/IV 47.803/V 28.678/VI 1.371; SIDS 2.385 đến 1.371) · C4 (thống nhất schema split 14.171/24.564/62.450) · R1.1 (bỏ nhãn HC1 sai trên bảng Pearson) · C2 (41 đến 40) · Singapore TP (82 đến 88,6) đã sửa trước. **Còn chờ:** re-lock số mô tả (43 raw .dta) · C5 (Emerging 47.803 vs 42.278 — cần NCS làm rõ scope) · citations (Wu Fan&Chen↔Li&Selover, Arte&Larimo, venue Đỗ&Phan — cần NCS) · đóng khung claim nhân quả "theo P3/P4".
...
| 2 | 🟥 | ~~Sửa "41 nước châu Á" đến **40**~~ Có ĐÃ SỬA 2026-06-10 (5 chỗ; 5 nhóm chính=40) | Mục 2.1.2, 2.1.3, 2.1.5, ghi chú Bảng 2.3.2.1 |
| 3 | 🟥 | Thống nhất **SIDS = 1.371 pool / 1.097 analytic**; sửa A.1 (2.385); làm rõ "9/52 SIDS" | Mục 2.1.4(6), A.1 |
| 4 | 🟥 | Chọn 1 bộ số **schema generation** (14.335/25.046/61.804 **hoặc** 14.171/24.564/62.450) | Mục 2.1.3 vs Mục 2.2 |
| 5 | 🟧 | Thống nhất **tổng Emerging** (47.803 vs 42.278) | Mục 2.3.7.5 |
| 6 | 🟧 | Sửa **citation**: Wu Fan&Chen↔Wu Li&Selover; thêm ref **Arte & Larimo (2022)**; khớp venue Đỗ&Phan (VEFR/JABS/JFAR/MIR) 1-1 với reference list | Mục 2.3.1.3, 254, 441, refs |
| 7 | 🟧 | Bỏ nhãn "HC1" khỏi bảng tương quan Pearson; bổ sung hệ số DAI hậu-loại-ICT | Bảng 2.3.8.1, Mục 2.3.4.3 |
| 8 | 🟨 | ~~Thống nhất Singapore TP (82% đến **88,6%**)~~ Có ĐÃ SỬA 2026-06-10 (2 chỗ); đóng khung lại claim nhân quả "theo P3/P4" (còn lại) | Mục 2.3.1.6, 2.4.2.1 |

**Ước lượng:** 1 vòng revision tập trung (số liệu + citation) là đủ đến sau đó **sẵn sàng nộp/bảo vệ**. Nội dung không cần viết lại.

> **Đã sửa cơ học 2026-06-10 (không mơ hồ):** C2 (41 đến 40, 5 chỗ) + Singapore TP (82 đến 88,6%, 2 chỗ) — đồng bộ `chuyen_de/` + `dist/chuyen_de_1/source_md/` + docx. **Còn chờ NCS quyết:** C1/C3/C5 (bảng n_firms nào chuẩn), citation (Wu Fan&Chen↔Li&Selover, Arte&Larimo, venue Đỗ&Phan), nhãn HC1, đóng khung claim nhân quả.
