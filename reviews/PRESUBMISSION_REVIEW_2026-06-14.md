...
|---|---|---|---|
| Prose em-dashes | P9=0, P10=0, P11=0; P7 prose=0 (2 in the internal reconciliation banner, not in the IBR submission copy; 1 in the Johanson & Vahlne 1977 *title*, faithful to the published source) | — | ✅ clean |
| AI-tone vocabulary | 1 occurrence ("underscore", P10 §5.3) → fixed to "show" | MINOR | ✅ fixed |
...
|---|---|---|
| P9/P10/P11/P7 | All carry the full chain: Abstract → Introduction → hypotheses/propositions → Data/Methods → Results → Discussion → Conclusion; contributions map to results sections. | — pass |
| P11 | Contribution framed honestly (DAI = pre-AI Tier-1 substrate, not AI); three findings map to Tables 1–4. | — pass |
| P7 | Three-zone narrative is internally consistent (abstract ↔ §4.6 ↔ §5); DAI level-shifter claim consistent throughout. | — pass |

## Dimension 2: Writing details
| # | Finding | Severity | Fix |
|---|---|---|---|
| 1 | P11 §5 has six subsections (5.1–5.6); a couple are short. | MINOR | optional: merge 5.2 into 5.1 for flow |
...
- P10/P11 build glyph-clean to PDF (xelatex). P7/P9 are markdown → docx via the CTU/Springer templates.
