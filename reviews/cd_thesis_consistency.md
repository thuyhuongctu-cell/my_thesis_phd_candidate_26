...
- **Việt hóa**: "pattern/Pattern" → "khuôn mẫu/Khuôn mẫu" (toàn bộ, 0 token còn lại); "voids" đứng riêng → "khoảng trống"; "in press" (thân bài) → "sắp xuất bản"; **"pool/Pool" → "mẫu gộp/Mẫu gộp"** (66 dòng thân CĐ1/CĐ2, khớp chuẩn đã dùng ở luận án và Phụ lục A; 0 token còn lại ngoài Abstract tiếng Anh).
