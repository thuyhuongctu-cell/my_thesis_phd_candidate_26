...
| 6 | **Đồng bộ schema M-AIDA (v7.0.1)** | `9d37f3b` | ICRV sửa về institutional I/II/III/FR/MX; cDAI → Digital Adoption Index 0–1; DOI/FP enum khớp DB; LLM không còn đoán moderator |
...
|---|---|:--:|---|
| P3 Việt Nam | MBR | ✅ | — |
| P4 Singapore | MIR | ✅ | — *(Leon đã gỡ)* |
| P5 Trung Quốc | IJOEM | ✅ | — |
| P6 Meta | JWB | ⏳ | **dual-coding κ/ICC + OSF DOI + 3 lệch Bảng 3.1 (mục C)** |
| P7 Capstone | JIBS | ✅ | — |
| P8 Pacific SIDS | World Development | ✅ | (tùy chọn) ký lại bằng Stata |
| P9 Ấn Độ | MIR | ✅ | — |

→ **6/7 sạch, sẵn sàng nộp.** P6 là đường găng duy nhất.
...
2. Chạy `python3 p6/icr/02_compute_icr.py` → ra 6 giá trị κ/ICC.
3. Điền vào 6 ô `[insert after dual-coding]` ở 4 package + bản VI; regenerate docx.
4. Đăng ký OSF → lấy DOI thật, thay placeholder `[insert OSF DOI at submission]`.
...
|---|---|---|---|
| DOI measure | Categorical **(4)** | **6** loại: FSTS/GEO/EXP/FDI/COMP/OTH | Sửa thành "(6)" HOẶC nêu rõ cách gộp 6→4 |
