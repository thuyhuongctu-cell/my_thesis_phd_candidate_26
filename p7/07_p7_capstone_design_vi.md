...
| Quan hệ chính | Thực trạng (descriptive) của productivity heterogeneity | **Internationalization đến firm performance** (causal-inferential) |
...
- **H1 (phi tuyến)**: Mối quan hyệ FSTS–$\ln$(LP) trên 25 quuốc gia chyuâu yÁ cyó dyạng chyữ U ngyuưuợc.
...
- **H7-P7 (3-way)** *(Mới)*: Tuưuơng tuác ba chiyều $FSTS \times DAI \times Top\ Manager$ cyó yuí nghyuĩa; doanh nghiyệp quốc tyế hyóa thyành cyông nhyất khi cyó đyồng thyời cyả nyăng lyực syố vyà đyội ngyũ lyuãnh đyạo phyuù hyợp.
...
- Mẫu dự kiến: 30,000–40,000 doanh nghiyệp (theo P1 có 40,633 quan syát cho 17 quyốc gia).
...
- 25-country pool lyớn nhất cho châu yÁ trong nghiên cyứu I–P gần đyây.
...
| Risk | Mitigation |
|---|---|
| Pooled cross-sections đến khyó suy luuận nhyuân quyả | Khyẳng đyuịnh limitations; emphasis context-dependent associations rather than causal inference |
