...
| 7 | CIMT (Capability-Institution Mismatch Theory) absent | 🟡 MEDIUM | 1-2h | ✅ **RESOLVED 2026-06-03 — direction (d)**: Restored CIMT framing in P7 §2.1 (new "Capability-Institution Mismatch as the unifying mechanism" paragraph with the 3 named sub-mechanisms — rent protection, LoF attenuation, institutional-void amplification — that P6 §2.2 also uses) + §5.1 contribution #1 (named "Capability-Institution Mismatch mechanism" as the first and most central contribution) + §1 contributions block (lead contribution rewritten to introduce CIMT). Abstract restructured to JIBS 7-section format with CIMT as the Purpose, Findings, and Originality framing. The framing positions P7 as **self-contained CIMT development** — does NOT cross-cite the unpublished P6 (avoids blind-review violation). When P6 is published, future P7 revision can cite back. Portfolio coherence: P6 develops CIMT theoretically + meta-analytically; P7 develops CIMT theoretically + firm-level multi-country test on N = 82,302. NCS to confirm with PGS.TS. Phan Anh Tú during defense preparation. |
