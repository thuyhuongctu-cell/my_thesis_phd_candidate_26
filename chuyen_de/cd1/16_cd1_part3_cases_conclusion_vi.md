...
FSTS 7,1%; doanh nghiệp xuất khẩu 17,8%; website 66,1%; ISO 23,3%; R&D 7,5%; FDI 31,5%. Độ lệch chuẩn log năng suất (sd log) 1,03. **Biên trên (upper boundary)** của nhóm Advanced đổi mới sáng tạo dẫn dắt. Theo bài báo P4 (Singapore — MIR): mô hình M8 cho R² hiệu chỉnh = 0,196; tương tác FSTS² × DAI = 3,119; điểm uốn (turning point) ở mức ~88,6%.

**Cập nhật bối cảnh hệ sinh thái 2025/2026 *(mới v3.6)***: Singapore tiếp tục khẳng định vị thế **biên trên tuyệt đối** của ICRV Nhóm I trên nhiều chỉ số đồng thời. Theo StartupBlink (2026), Singapore xếp **hạng 2 toàn cầu** trong Innovators Business Environment Index 2026 (IBEI 2026, điểm 99,145/100; hạng 1 châu Á–Thái Bình Dương), đánh giá theo 30+ tham số thuộc 5 nhóm: Quy định & Quản trị, Tiếp cận vốn & Hạ tầng tài chính, Thuế, Hạ tầng số, và Hội nhập toàn cầu. Trong Global Startup Ecosystem Index 2025, Singapore xếp **hạng 4 toàn cầu** (tăng từ hạng 5 năm 2024) với tốc độ tăng trưởng hệ sinh thái 44,9% — gấp 1,6 lần mức trung bình top-20 (28,5%) (StartupBlink, 2025). Khảo sát Chính phủ điện tử Liên Hợp Quốc 2024 xếp Singapore **hạng 3 thế giới** (GovTech Singapore, 2024). Sáng kiến **Smart Nation 2.0** (ra mắt 2024) thể chế hóa phát triển số quốc gia theo ba trụ cột: Tin tưởng — Tăng trưởng — Cộng đồng, phản ánh giai đoạn chín muồi hoàn toàn của hạ tầng số Singapore.

**Hệ sinh thái khởi nghiệp và đổi mới**: Singapore là điểm hội tụ của các sự kiện công nghệ hàng đầu khu vực. **SWITCH 2025** (Singapore Week of Innovation and Technology, Enterprise Singapore), kỷ niệm lần thứ 10, thu hút kỷ lục 25.000 người tham dự từ hơn 100 quốc gia; cuộc thi SLINGSHOT nhận 6.800 đơn từ 150 thị trường với tổng giải thưởng S$2 triệu (Enterprise Singapore, 2025). **ATxSG 2025** (Asia Tech x Singapore, IMDA), lần thứ 5, tập hợp 22.000 người từ 110 khu vực, 450+ diễn giả, 700+ gian hàng, 34 pavilion quốc gia (IMDA, 2025). Quy mô này minh chứng rằng hệ sinh thái đổi mới Singapore vận hành ở **Tier 3–4** (tích hợp AI, tự động hóa, nền tảng platform) — vượt xa hơn nhiều so với lớp DAI Tier 1–2 (website + e-payment) được đo lường trong thiết kế WBES. Đây chính là lý do tại sao **Digital Saturation Paradox** xuất hiện trong P4: các công cụ số cơ bản đã trở thành hygiene factor tại Singapore, và phần bù năng suất (productivity premium) của DAI chỉ còn đo được ở nhóm xuất khẩu cường độ cao — nơi nhu cầu phối hợp xuyên biên giới đủ dày để kích hoạt cơ chế CDCM.
...
**Trường hợp Ấn Độ — chứng cứ technology spillovers (NEW v3.2)**: Theo Sikdar và Mukhopadhyay (2026 — *Asian Development Review, 43*(1), pp.37-75), nghiên cứu panel **4.293 doanh nghiệp Ấn Độ giai đoạn 2006-2019**. Phát hiện: FDI là kênh horizontal spillover quan trọng nhất; doanh nghiệp lớn và hiệu quả cao capture spillovers nhiều nhất; FDI inflows tăng từ $1,705M (1990-2000) → $42,396M (2012-2022); R&D stagnant ở 0,7% GDP; patent applications resident filing +11,9%/năm 2012-2022.
...
(c) **Mô hình Trung Quốc — smart manufacturing + concentration risk warning** *(Tier-2/3 hybrid + cảnh báo)*: Trung Quốc dẫn đầu Asia trong smart manufacturing với Industry 4.0 standards — Foxconn Shenzhen, BYD, Geely. Tuy nhiên **80% bank risk models PRC phụ thuộc dominant tech providers** (Wang/Huang/Hong, 2024 — *IRFA*) → concentration risk cao. Việt Nam cần học positive (smart manufacturing roadmap) nhưng **TRÁNH** lock-in vào single foreign vendor — đẩy mạnh open standards + multi-vendor procurement cho FDI manufacturing.
