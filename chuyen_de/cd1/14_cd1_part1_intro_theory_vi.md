...
3. Phân tích thực trạng đa chiều hiệu quả doanh nghiệp ở **40 nước châu Á (scope chính)** + so sánh với 7 SIDS Pacific (boundary case);
...
**A. Scope chính — 40 nước châu Á thuần** (theo tiêu đề luận án "Châu Á" trong Quyết định 4769/QĐ-ĐHCT 15/10/2024):
...
- Cyprus không được tính vào 40 nền kinh tế châu Á (không có dữ liệu WBES trong phạm vi nghiên cứu).
...
**Bốn đóng góp scope chính cho 40 nước châu Á**:
...
Khái niệm "chi phí buộc phải quốc tế hóa SIDS Pacific" cần được tách khỏi luận điểm thể chế điều tiết cường độ U-curve — hai loại điều tiết này có bản chất khác nhau: (i) thể chế **điều tiết cường độ lợi nhuận** từ quốc tế hóa (U-curve operating); (ii) thể chế **quyết định sự tồn tại của quy luật U-curve** (boundary case). Thiết lập 3 điều kiện cấu trúc cho U-curve từ sớm trong Chương 2 giúp Chương 4–5 phân tích sự thất bại một cách có hệ thống. SIDS Pacific là trường hợp **đường cong U ngược (Lu & Beamish, 2004) bị biến dạng thành đường cong đảo ngược** — không phải dị biệt ngẫu nhiên mà là điều kiện biên (boundary condition — Bello & Kostova, 2012) của lý thuyết.
...
Một construct validity gap cần lưu ý: DAI đo lường trong chuyên đề này chỉ chạm tầng cơ bản (Tier 1 = website binary; Tier 1+2 = website + e-payment), trong khi lý thuyết về *super-linear coordination cost* (Brynjolfsson & McAfee, 2014) đòi hỏi tầng tích hợp sâu (Tier 3) hoặc năng lực động (Tier 4). Cần thiết lập explicit **construct boundary** từ Chương 2 — trước khi báo cáo descriptive results — để phòng tránh "overclaiming" và đảm bảo tính nhất quán khi nộp hội đồng.
...
CDCM hợp nhất phát hiện Singapore P4 (Mar et al., 2026) + Việt Nam P3 (Đỗ & Phan, 2026 — *APJM*) thành một khung xuyên quốc gia 3 chiều:
...
- **Robustness check #10** (mới): cross-validation construct boundary — chạy Spec 2 chỉ ở 40 nước có đủ Tier 1+2 data (BREADY+ wave); confirm rằng pattern Singapore-style emerges khi có composite digital adoption metric;
...
**Tham chiếu**: Verhoef et al. (2021); Bharadwaj et al. (2013); Brynjolfsson & McAfee (2014); Mar et al. (2026 — P4 Singapore manuscript, *MIR* under review); Đỗ & Phan (2026 — P3 Việt Nam — *APJM*); Coase (1937); Williamson (1985); Banalieva & Dhanaraj (2019).
