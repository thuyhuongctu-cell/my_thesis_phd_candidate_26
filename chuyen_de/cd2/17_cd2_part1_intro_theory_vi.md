...
**Sơ đồ tích hợp — Hình 2.1** (preview; phiên bản đầy đủ tại Hình 4.1 file 18 §4.1, sơ đồ PlantUML render-ready):
...
Năm tầng tác động đồng thời và *không thể giản lược*. Sáu giả thuyết H1–H6 được test trong tám mô hình M0–M7 (xem §6 file 19 — đặc tả mô hình lồng nhau).
