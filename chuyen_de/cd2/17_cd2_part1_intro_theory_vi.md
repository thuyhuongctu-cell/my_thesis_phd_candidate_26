...
Chuyên đề này xây dựng mô hình nghiên cứu lý thuyết và thực nghiệm về ảnh hưởng của quốc tế hóa đến hiệu quả hoạt động kinh doanh của các doanh nghiệp ở các quốc gia châu Á trong giai đoạn 2009–2025. Khung lý thuyết tích hợp bốn tầng — Uppsala Model (Johanson & Vahlne, 1977, 2009), Resource-Based View (Barney, 1991; Wernerfelt, 1984), Institutional Theory (North, 1990; Khanna & Palepu, 2010; Peng, 2003) và Upper Echelons Theory (Hambrick & Mason, 1984; Hambrick, 2007) — kết hợp với Digital Capability Lens (Banalieva & Dhanaraj, 2019; Verhoef et al., 2021; Stallkamp & Schotter, 2021) làm nền tảng. Lược khảo năm dạng hàm I→P (linear, inverted-U, S-curve, M-curve, forced penalty) và năm meta-analysis lớn 1980–2024 cho thấy khoảng trống thực nghiệm trong việc kiểm định đồng thời phi tuyến và moderation đa tầng ở châu Á. Hệ giả thuyết H1–H6 được phát triển: H1 phi tuyến S-curve; H2 Technological Capability Index (TCI) điều tiết tích cực; H3 Digital Adoption Index (DAI) điều tiết tích cực và phân biệt với TCI; H4 đặc điểm nhà quản trị điều tiết; H5 thể chế nội địa điều tiết theo gradient ICRV năm regime; H6 heterogeneity theo thời gian. Tám mô hình thực nghiệm M0–M7 được đặc tả, từ baseline tuyến tính đến three-way moderation cấp luận án. Chiến lược nhận dạng đa tầng và kế hoạch kiểm định độ vững toàn diện được thiết kế cho pool 101.185 doanh nghiệp ở 47 nền kinh tế châu Á và Pacific. Đóng góp chính của chuyên đề: (i) khung tích hợp 4 tầng + Digital lens chưa có tương đương cho châu Á; (ii) tách bạch TCI và DAI; (iii) mô hình M7 ba chiều moderation; (iv) sub-grouping Advanced regime (innovation-driven vs resource-driven).

**Từ khóa**: quốc tế hóa; hiệu quả hoạt động kinh doanh; châu Á; mô hình phi tuyến; điều tiết; năng lực số; thể chế; Upper Echelons.

---

## ABSTRACT

This specialty essay constructs a theoretical and empirical research model on the effect of internationalization on firm performance across Asian economies during 2009–2025. The integrated theoretical framework combines four layers — the Uppsala Model (Johanson & Vahlne, 1977, 2009), the Resource-Based View (Barney, 1991; Wernerfelt, 1984), Institutional Theory (North, 1990; Khanna & Palepu, 2010; Peng, 2003), and Upper Echelons Theory (Hambrick & Mason, 1984; Hambrick, 2007) — together with the Digital Capability Lens (Banalieva & Dhanaraj, 2019; Verhoef et al., 2021; Stallkamp & Schotter, 2021). A review of five functional forms (linear, inverted-U, S-curve, M-curve, forced penalty) and five major meta-analyses (1980–2024) identifies an empirical gap in the simultaneous testing of nonlinearity and multi-level moderation in Asia. Six hypotheses (H1–H6) are developed: H1 nonlinear S-curve relationship; H2 Technological Capability Index (TCI) positively moderating; H3 Digital Adoption Index (DAI) positively moderating and distinguishable from TCI; H4 top manager characteristics moderating; H5 home-country institutions moderating along the ICRV regime gradient; H6 temporal heterogeneity. Eight empirical models M0–M7 are specified, from linear baseline to three-way moderation. A multi-level identification strategy and comprehensive robustness plan are designed for a pool of 101,185 firms across 47 Asian and Pacific economies. The main contributions are: (i) an integrated 4-tier + Digital lens framework with no equivalent for Asia; (ii) the separation of TCI and DAI; (iii) the M7 three-way moderation model; (iv) sub-grouping of the Advanced regime into innovation-driven and resource-driven types.

**Keywords**: internationalization; firm performance; Asia; nonlinear models; moderation; digital capability; institutions; Upper Echelons.
...
| HC3 | Heteroskedasticity-Consistent Standard Errors (Long & Ervin, 2000) |
...
Châu Á trong giai đoạn 2009–2025 là phòng thí nghiệm tự nhiên (natural laboratory) độc đáo cho nghiên cứu quan hệ I→P. Khu vực này tồn tại đồng thời ít nhất **năm regime thể chế khác nhau**: (i) advanced economies với innovation-driven (Singapore, Hong Kong, Hàn Quốc, Đài Loan) và resource-driven (Saudi Arabia, Qatar, Kuwait, Bahrain); (ii) upper-middle income economies trong giai đoạn chuyển đổi (Trung Quốc, Malaysia, Thái Lan); (iii) emerging economies hội nhập sâu (Việt Nam, Indonesia, Ấn Độ, Philippines); (iv) frontier economies thu nhập trung bình thấp đang phát triển (Bangladesh, Pakistan, Nepal, Lào, Campuchia); và (v) Pacific small island developing states (Fiji, Papua New Guinea, Solomon Islands, Tonga, Vanuatu, Samoa) làm boundary case cực đặc biệt. Sự đa dạng này cho phép kiểm định đồng thời các giả thuyết về phi tuyến và moderation đa tầng — điều mà các nghiên cứu hiện hành thường không thể thực hiện do giới hạn phạm vi địa lý.
...
Chuyên đề 1 ("Thực trạng về hiệu quả hoạt động kinh doanh của các doanh nghiệp ở châu Á") đã cung cấp bức tranh thực trạng đa chiều dựa trên 101.185 doanh nghiệp WBES, làm rõ ba pattern then chốt: (a) dispersion năng suất tăng đơn điệu theo regime declension; (b) heterogeneity nội bộ trong Advanced (innovation vs resource); (c) SIDS Pacific có pattern adaptation đặc trưng (innov_product 41,5%, website 58,9%, R&D 11,8%). Chuyên đề 2 này tiếp nối: **xây dựng mô hình lý thuyết và thực nghiệm để giải thích cơ chế đằng sau các pattern đó**.
...
**(Q2)** Bốn cơ chế điều tiết — năng lực công nghệ TCI, mức độ áp dụng số DAI, đặc điểm nhà quản trị, regime thể chế nội địa — tác động như thế nào lên quan hệ I→P? Có phân biệt được giữa TCI và DAI hay không?
...
Ba câu hỏi trên được trả lời bằng cách (i) tổng hợp văn liệu lý thuyết và thực nghiệm hiện hành; (ii) phát triển hệ giả thuyết H1–H6 dựa trên khung tích hợp; (iii) đặc tả tám mô hình thực nghiệm M0–M7; (iv) thiết kế chiến lược dữ liệu và nhận dạng đa tầng.
...
1. Hệ thống hóa khung lý thuyết tích hợp 4 tầng (Uppsala, RBV, Institutional Theory, Upper Echelons) kết hợp Digital Capability Lens.

2. Lược khảo các mô hình I→P trên thế giới và châu Á, định vị khoảng trống nghiên cứu.

3. Phát triển hệ giả thuyết H1–H6 dựa trên khung tích hợp.
...
**Đối tượng nghiên cứu**: doanh nghiệp đang hoạt động ở các nền kinh tế châu Á và Pacific đáp ứng tiêu chí mẫu của WBES.

**Phạm vi không gian**: 47 nền kinh tế châu Á và Pacific với coverage WBES (xem chi tiết ở `thesis/16_cd1_part3_cases_conclusion_vi.md` Phụ lục A): 11 Advanced (Singapore, Hong Kong, Hàn Quốc, Đài Loan, Israel, Bahrain, Brunei, Cyprus, Saudi Arabia, Qatar, Kuwait), 6 Upper-middle (Trung Quốc, Malaysia, Thái Lan, Kazakhstan, Armenia, Georgia), 7 Emerging (Việt Nam, Indonesia, Philippines, Ấn Độ, Sri Lanka, Jordan, Mongolia), 17 Frontier (Bangladesh, Pakistan, Lào, Campuchia, Myanmar, Nepal, Bhutan, Maldives, Uzbekistan, Tajikistan, Kyrgyzstan, Turkmenistan, Afghanistan, Timor-Leste, Iraq, Lebanon, Yemen), 6 SIDS Pacific (Fiji, Papua New Guinea, Solomon Islands, Tonga, Vanuatu, Samoa).

**Phạm vi thời gian**: 2009–2025 (15 năm × 14 mốc khảo sát có sẵn), bao trùm ba thế hệ schema WBES và năm lớp bối cảnh kinh tế chồng lấn.
...
3. **Sub-grouping Advanced regime**: phát hiện ở Chuyên đề 1 cho thấy Advanced có hai loại — innovation-driven (Singapore, Hong Kong, Korea, Đài Loan) và resource-driven (Saudi, Qatar, Kuwait, Bahrain) — với pattern hiệu quả khác nhau. CĐ2 đề xuất sub-grouping này trong mô hình M7. Singapore là neo đậu thực nghiệm cho ICRV Nhóm I: xếp hạng 2 toàn cầu trong StartupBlink Innovators Business Environment Index 2026 (điểm 99,145/100; hạng 1 châu Á-Thái Bình Dương qua hơn 30 tiêu chí quản trị, tiếp cận vốn, thuế và hạ tầng số), hạng 4 trong Global Startup Ecosystem Index 2025, hạng 3 trong UN e-Government Survey 2024, và Smart Nation 2.0 (2024) thể chế hóa hạ tầng tin cậy số như ưu tiên chính sách quốc gia — đặt Singapore ở trần của phổ thể chế ICRV, nơi cơ chế bão hòa số (digital saturation paradox) là rõ ràng nhất (Đỗ & Phan, 2026 — P4 MIR).
...
2. **Heterogeneity thời gian H6**: kiểm định tương tác I × Year-bucket cho ba giai đoạn 2009–2012, 2013–2017, 2018–2025 — bao trùm cả COVID-19 và AI bùng nổ.

**Về phương pháp** (2 đóng góp):

1. **Giao thức hòa hợp ba thế hệ schema WBES** trên 105 file → pool 101.185 doanh nghiệp ở 47 nước × 108 cặp năm (xem `thesis/08_p7_data_harmonization_protocol_vi.md`). Đây là pool có phạm vi rộng nhất từng có cho nghiên cứu I→P trong văn liệu.

2. **Chiến lược nhận dạng đa tầng** kết hợp HC3 robust SE (Long & Ervin, 2000), country × year fixed effects, và sub-sample replication theo regime ICRV.

**Về thực tiễn** (1 đóng góp):

- Cung cấp **hàm ý chính sách** cho doanh nghiệp Việt Nam và emerging Asia về cách tận dụng quốc tế hóa kết hợp năng lực số — đặc biệt trong giai đoạn AI bùng nổ.

### 1.6 Phương pháp tiếp cận

Chuyên đề tiếp cận theo lối **integrative literature review** (Torraco, 2005) cho khung lý thuyết và **deductive hypothesis development** cho hệ giả thuyết. Đặc tả mô hình thực nghiệm theo Wooldridge (2010) và Long & Ervin (2000); thiết kế nhận dạng và kiểm định độ vững theo Greene (2018).
...
**Vai trò trong CĐ2**. RBV cung cấp lý thuyết cho **hệ giả thuyết H2 (TCI điều tiết tích cực)**: doanh nghiệp có năng lực công nghệ (R&D, ISO, máy nhập khẩu) cao hấp thụ lợi ích quốc tế hóa tốt hơn doanh nghiệp năng lực thấp. TCI là biến điều tiết cấp doanh nghiệp.
...
**Strategy Tripod**. Peng (2003) và Peng, Wang, Jiang (2008) đề xuất **strategy tripod** — chiến lược doanh nghiệp được hình thành bởi ba lực: industry (ngành), resources (nguồn lực), và institutions (thể chế). Trong các nền kinh tế emerging và frontier, vai trò của institutions đặc biệt nổi bật — bằng hoặc cao hơn industry và resources.

**Vai trò trong CĐ2**. Lý thuyết thể chế cung cấp logic cho **hệ giả thuyết H5 (institutional moderation theo gradient ICRV)**: cùng một mức quốc tế hóa, doanh nghiệp ở Advanced (thể chế hoàn thiện) thu được hiệu quả khác doanh nghiệp ở Frontier (institutional voids) khác doanh nghiệp ở SIDS (forced internationalization). Regime ICRV năm nhóm là biến điều tiết cấp quốc gia.
...
### 2.5 Lăng kính số — Digital Capability Lens
...
- **Technological Capability (TCI)**: nội tại — R&D doanh nghiệp, đổi mới sản phẩm, chứng nhận chất lượng (ISO), bằng sáng chế. Đo lường bằng đầu vào và đầu ra của hoạt động đổi mới.
- **Digital Adoption (DAI)**: ngoại tại — sử dụng hạ tầng số (website, e-commerce, ERP, cloud, AI tools). Đo lường bằng việc adoption của công cụ số có sẵn.
...
**Bằng chứng emerging Asia**. Yang, Zhao và Wei (2025) tổng hợp bằng chứng từ Trung Quốc, Ấn Độ, Việt Nam cho thấy năng lực số là moderator mạnh nhất cho quan hệ I→P trong giai đoạn 2018+.
...
| Tầng | Lý thuyết | Câu hỏi phụ | Biến số chính | Giả thuyết |
|---|---|---|---|---|
| 1 | Uppsala | Cường độ quốc tế hóa tăng dần có hiệu ứng phi tuyến không? | I (FSTS) | **H1** Phi tuyến S-curve |
| 2 | RBV | Năng lực doanh nghiệp ảnh hưởng thế nào đến hấp thụ lợi ích I? | TCI | **H2** TCI moderation (+) |
| 5 | Digital lens | Năng lực số có cơ chế khác TCI không? | DAI | **H3** DAI moderation (+), riêng biệt |
| 4 | Upper Echelons | Đặc điểm nhà quản trị tác động thế nào? | Top manager | **H4** Manager moderation |
| 3 | Institutional | Thể chế nội địa định hình quan hệ ra sao? | ICRV regime | **H5** Institutional moderation gradient |
| – | (Temporal) | Quan hệ thay đổi qua thời gian không? | Year-bucket | **H6** Temporal heterogeneity |
...
```
   ...
   │                  │                  │                  │
   ▼                  ▼                  ▼                  ▼
RBV (Tầng 2)   Digital lens       Upper Echelons    Institutional (Tầng 3)
    TCI            DAI               Manager          ICRV regime
  (Doanh nghiệp) (Doanh nghiệp)    (Doanh nghiệp)    (Quốc gia)
```

**Lập luận tích hợp**. Quốc tế hóa là quyết định chiến lược của doanh nghiệp (Uppsala); kết quả của quyết định này phụ thuộc vào nguồn lực doanh nghiệp (RBV/TCI); được hỗ trợ bởi hạ tầng số (Digital lens/DAI); phản ánh đặc điểm top managers (Upper Echelons); và bị khuôn khổ bởi thể chế nội địa (Institutional Theory/ICRV regime). Năm tầng tác động đồng thời, không thể giản lược.

### 2.7 Hạn chế của khung tích hợp

**Vấn đề nhận dạng nhân quả**. Khó tách hiệu ứng riêng từng tầng nếu không có dữ liệu panel dài. WBES không phải panel chuẩn → cần sử dụng cross-section lặp với fixed effects.
...
**Phụ thuộc vào schema WBES**. Khung tích hợp giới hạn bởi biến có sẵn trong schema 2018+. Một số biến top manager chỉ có ở vài đợt khảo sát.
