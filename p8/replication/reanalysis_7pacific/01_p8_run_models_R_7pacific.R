...
# ── Paths ─────────────────────────────────────────────────────────────────────
DATA_PATH   <- "/home/user/MY_THESIS_PHD_CANDIDATE_26/data_wbes/p7/p7_pooled_clean.csv"
RESULTS_DIR <- "/home/user/MY_THESIS_PHD_CANDIDATE_26/p8/replication/reanalysis_7pacific"
...
df_sids <- df_raw[df_raw$icrv_label == "SIDS_small", ]
 df_sids <- df_sids[!(df_sids$country %in% c("Comoros","TimorLeste")), ]
