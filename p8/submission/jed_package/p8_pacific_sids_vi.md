...
Bài báo này có ba đóng góp vào các nghiên cứu IB. Thứ nhất, chúng tôi cung cấp một tên gọi có cấu trúc và sự vận hành hóa thực nghiệm rõ ràng cho cơ chế quốc tế hóa SIDS mà tài liệu SIDS nền tảng (Briguglio, 1995; Bertram, 2006 MIRAB; Briguglio et al., 2009) đã phân tích lâu dài ở cấp vĩ mô. Cấu trúc ba điều kiện tiền đề (thị trường nội địa không khả thi, chi phí thương mại quá cao, khoảng trống thể chế toàn diện) đã được thiết lập; đóng góp của chúng tôi là sự vận hành hóa ở cấp doanh nghiệp, nhãn FIP kết nối các ràng buộc vĩ mô đó với dấu của hệ số FSTS trong các hồi quy I-P, và bằng chứng cho thấy chữ ký cấp doanh nghiệp này có thể được khôi phục trong dữ liệu WBES. Chúng tôi phân biệt FIP với các khái niệm cấp doanh nghiệp liền kề bao gồm chi phí giai đoạn 1 trong lý thuyết ba giai đoạn (Contractor et al., 2003), Trách nhiệm ngoại lai (Liability of Foreignness — Zaheer, 1995), và khởi nghiệp bắt buộc (necessity entrepreneurship — Sarasvathy et al., 2014).
