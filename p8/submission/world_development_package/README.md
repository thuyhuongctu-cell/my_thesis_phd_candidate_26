...
*Note: Manuscript contains 3 tables (country stats, regression matrix, exporters robustness). No standalone figures.*
...
| Item | Value |
|------|-------|
| Word count (main text, excl. tables/refs) | ~7,500 words |
| Abstract | ~200 words |
...
Main markdown: `p8/p8_pacific_sids_en_clean.md`
Design document: `p8/10_p8_pacific_sids_design_vi.md`
Replication: `p8/replication/`
R results: `p8/replication/results/p8_R_coefs.csv`, `p8_R_summary.csv`
