...
## Công bố sử dụng AI tạo sinh trong quá trình viết

Trong quá trình chuẩn bị bản thảo này, (các) tác giả đã sử dụng Grammarly, một công cụ hỗ trợ viết, để sửa chính tả, ngữ pháp, và dấu câu trong văn bản gốc của chính (các) tác giả. Không có công cụ trí tuệ nhân tạo tạo sinh nào được dùng để tạo, soạn thảo, hay sản sinh bất kỳ nội dung thực chất, phân tích, hay diễn giải nào. Sau khi sử dụng công cụ này, (các) tác giả đã rà soát, chỉnh sửa nội dung khi cần và chịu trách nhiệm hoàn toàn về nội dung công bố.
