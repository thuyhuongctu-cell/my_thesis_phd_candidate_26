...
Cơ sở M0 (chỉ biến kiểm soát, không có FSTS) cho R² là 0,7992; thêm FSTS_c trong M1 tăng R² một chút lên 0,8001, cho thấy rằng, có điều kiện trên hiệu ứng cố định quốc gia và năm, FSTS giải thích phương sai bổ sung hạn chế nhưng theo chiều âm nhất quán.
...
Mô hình là **quan hệ âm đơn điệu**, nhất quán với H1 và cơ chế cấu trúc FIP. Không có điểm ngưỡng trong phạm vi FSTS quan sát được (0–1). Điều này xác nhận FIP: không có điểm ngưỡng trong phạm vi dữ liệu.
