...
**Bảng 4.1**. *Phân tán (dispersion) năng suất lao động theo phân nhóm con thể chế (n=108 cặp QG×năm, v3.1; nguồn dữ liệu: P7 pooled, dispersion tính trên ln(LP) đã loại trừ trung bình quốc gia × năm).*

| Phân nhóm con | Cặp QG×năm | n_firms | sd log | P90/P10 | P75/P25 |
|---|---|---|---|---|---|
| **Advanced, innovation-driven** *(SG, HK, KOR, TWN, ISR, CYP)* | 8 | 3.881 | **1,13** | **14,05** | **3,55** |
| **Advanced, resource-driven** *(SAU, QAT, KWT, BHR, BRN)* | 5 | 1.810 | **0,72** | **3,99** | **1,76** |
| *Advanced (gộp, tham chiếu)* | 13 | 5.691 | 1,01 | 10,8 | 3,1 |
| Upper-middle | 18 | 15.174 | 1,29 | 27,7 | 5,4 |
| Emerging | 20 | 45.388 | 1,24 | 30,6 | 5,1 |
| Frontier | 42 | 18.877 | 1,36 | 39,6 | 6,1 |
| **SIDS Thái Bình Dương (v3.1: gồm Kiribati 2025)** | **13** | **1.352** | **1,50** | **32,62** | **6,15** |

*Ghi chú: Advanced tách 2 phân nhóm con ở v3.1; tỷ số phân tán tiên tiến đổi mới sáng tạo (sd log 1,13) so với tiên tiến tài nguyên dẫn dắt (sd log 0,72) ≈ **1,6 lần**. SIDS Thái Bình Dương có phân tán cao nhất pool (P90/P10 = 32,62), phù hợp với pattern survival-based internationalization (Bertram, 2006). Dispersion tính trên ln(LP) demeaned theo cặp quốc gia × năm để loại trừ chênh lệch tiền tệ danh nghĩa xuyên nước. Nguồn: P7 pooled clean (49 nền kinh tế; Đỗ & Phan, 2026, đang revision JIBS).*
...
**Bảng 4.5.6**. *Tỷ lệ nữ quản lý cấp cao (female top manager) và nữ sở hữu, theo phân nhóm con ICRV (nguồn: P7 pooled clean, n=87.872 doanh nghiệp; trường WBES b7a + b4).*

| Phân nhóm con | n | % Nữ Top Manager (b7a) | % Nữ Owner (b4) | Ghi chú |
|---|---|---|---|---|
| **Advanced, innovation-driven** | 4.695 | **25,6%** | **33,3%** | Singapore/HK/Korea/Taiwan/Israel/Cyprus |
| **Advanced, resource-driven** | 1.932 | **4,0%** | **8,9%** | Vùng Vịnh, thấp do cấu trúc xã hội-thể chế |
| **Upper-middle** | 10.349 | **31,2%** | **33,9%** | Trung Quốc, Malaysia, Thái Lan dẫn dắt |
| **Emerging** | 48.297 | **13,2%** | **24,7%** | Việt Nam, Indonesia, Philippines, Ấn Độ |
| **Frontier** | 21.157 | **13,6%** | **21,5%** | Phân tán lớn xuyên Bangladesh, Pakistan, Cambodia, Trung Á |
| **SIDS Thái Bình Dương** | 1.442 | **31,8%** | **40,8%** | Cao nhất pool, Fiji/Samoa/Solomon Islands có matrilineal land tenure culture |

*Lưu ý: Số liệu thực tế đã được tính trực tiếp từ P7 pooled clean (Đỗ & Phan, 2026, JIBS revision); cao hơn ước tính ban đầu cho SIDS Thái Bình Dương (matrilineal culture pattern xác nhận) và thấp hơn ước tính cho Emerging Asia (chỉ Đông Nam Á cụ thể có pattern cao). Bảng 6.1.1 (file 16 Mục 6.1) cung cấp số liệu theo vùng WB rộng hơn.*
