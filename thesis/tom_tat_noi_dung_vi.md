...
Phát hiện nhất quán nhất và có ý nghĩa lý thuyết rộng nhất của luận án là **dải biến thiên ICRV (Institutional Context Regime Variation, biến thiên chế độ bối cảnh thể chế)**: cùng một mức độ quốc tế hóa (FSTS) lại mang lại hiệu quả rất khác nhau, tùy vào chế độ thể chế mà doanh nghiệp hoạt động. Hai nguồn bằng chứng độc lập cùng chỉ về một kết luận, đó là phân tích tổng hợp (P6, $Q_M = 17{,}35$, $df = 4$, $p = {,}002$) và phân tích dữ liệu sơ cấp toàn mẫu (P7, $N = 82.302$ quan sát từ 45 nền kinh tế): độ cong (concavity) của quan hệ I-P **sâu dần** khi chất lượng thể chế suy giảm — phẳng, gần như tuyến tính ở nhóm tiên tiến và rõ nét nhất (hình chữ U ngược) ở nhóm đảo nhỏ và cận biên — với điểm uốn dao động quanh ~40% thay vì dịch chuyển đơn điệu. Nói cách khác, ở các nền kinh tế thể chế mạnh, quan hệ I–P gần như tuyến tính trong khoảng quan sát và doanh nghiệp ít chịu hình phạt suy giảm khi quốc tế hóa sâu; còn ở các nền kinh tế thể chế yếu, hình chữ U ngược biểu hiện rõ nét, phản ánh chi phí phối hợp và lợi suất giảm dần gay gắt hơn khi đẩy mạnh xuất khẩu.
...
- **P7** (Do & Phan, 2026d): kiểm định toàn mẫu châu Á và Thái Bình Dương với $N = 82.302$ (M2) và $N = 38.342$ (M3-M5 có đầy đủ biến kiểm soát), điểm uốn 36,4-40,0% (M2-M5; M11 đầy đủ: điểm uốn 25,7%, $p_\text{LM} = {,}026$); dải biến thiên ICRV được xác nhận mạnh mẽ, TCI nâng mặt bằng năng suất phổ quát, DAI điều tiết đường cong có ý nghĩa trên toàn mẫu và mạnh hơn ở thể chế yếu (DAI×ICRV $p = {,}049$).
