...
|---|---|---|
| Loại nghiên cứu | Single meta-analysis paper | **Cumulative dissertation 9 papers** |
...
- Đầu tiên **cumulative thesis 9 papers** với 2 đã công bố
...
## 7.3 "Vì sao chưa yếu về việc có 9 papers"
...
→ Vietnamese typical: 1–3 papers. NCS = 9 papers.
```
