...
|---|---|---|
| **# tuyến phân tích** | 1–3 | **Nhiều tuyến: tổng hợp + đa quốc gia + theo từng nền kinh tế + trường hợp biên** |
| **# countries** | 1 (Asian focus) | **47–49** |
...
| **Publication track** | 0–1 paper công bố | **2 bài đã công bố + mức tham chiếu ICBEF proceedings** |
...
| **# countries** | 32 | Multi-EMNE | Multi | 1 (US) | 1 (Colombia) | 1 (Japan) | 1 (VN) | **47–49** |
...
| **Institutional gradient** | Yếu | Yếu | Yếu | Không | Một biến | Không | Không | **Full ICRV Regime I→V (6-regime CD2; 5-regime phân tích Việt Nam và tổng hợp)** |
...
- 1 bài đã có trong kỷ yếu ICBEF 2025 (phân tích tổng hợp baseline)
- 5 bài đang ở các giai đoạn bản thảo khác nhau (phân tích Việt Nam, Singapore và Trung Quốc, phân tích đa quốc gia và SIDS Thái Bình Dương)
...
- phân tích tổng hợp baseline (ICBEF 2025): đã công bố
- phân tích Việt Nam: bản thảo hoàn chỉnh — hướng tới JED (Journal of Economics and Development, Emerald trên danh nghĩa NEU, Scopus + WoS, IF 4.3)
- phân tích Singapore: bản thảo hoàn chỉnh — hướng tới JABES (Journal of Asian Business and Economic Studies, Emerald trên danh nghĩa UEH HCM, Scopus Q1, IF 3.9, Diamond OA)
- phân tích Trung Quốc: bản thảo hoàn chỉnh — hướng tới IJOEM (International Journal of Emerging Markets, Emerald)
- phân tích tổng hợp: bản thảo hoàn chỉnh — MIR (Management International Review, Springer, Scopus Q1)
- phân tích đa quốc gia: bản thảo hoàn chỉnh — JIBS (Journal of International Business Studies), đang chỉnh sửa
- phân tích SIDS Thái Bình Dương: bản thảo hoàn chỉnh — JED (Journal of Economics and Development, Emerald trên danh nghĩa NEU, Scopus + WoS, IF 4.3)

Lộ trình **dự kiến tốt nghiệp năm 2027**:
- 2026 H2: nộp phân tích Việt Nam, Singapore và Trung Quốc — hồ sơ nộp bài hoàn chỉnh (JABS/MIR/IJOEM)
- 2027 H1: ít nhất 1 bài được chấp nhận; nộp lại các bản chỉnh sửa phân tích tổng hợp và đa quốc gia/phân tích SIDS Thái Bình Dương
...
**Trả lời**: Tính mới của luận án nằm ở việc chứng minh rằng **quan hệ chữ U ngược có các điều kiện biên**. Mỗi chế độ thể chế cần ít nhất 3 quốc gia để bảo đảm công suất thống kê (chuẩn của Marano 2016 là từ 5 quốc gia trở lên cho mỗi chế độ). 45 nền kinh tế chia thành 6 chế độ (ICRV I–VI), trung bình khoảng 8 nền kinh tế mỗi chế độ, đủ công suất thống kê.
...
## 8.4 GVHD có thể hỏi: "phân tích SIDS Thái Bình Dương Pacific không thuộc châu Á, vì sao lại đưa vào luận án?"
...
Contractor, F. J., Kumar, V., & Kundu, S. K. (2007). Nature of the relationship between international expansion and performance. *Journal of World Business, 42*(4), 401–417.
...
8 PAPERS (P1–phân tích SIDS Thái Bình Dương):
✅ P1 Emerging Asia 17 economies (VEFR 2026)
✅ P2 China SMEs (JFAR 2026)
✅ phân tích Việt Nam Vietnam — Nhóm IV (Lower_mid_transition), inverted-U (TP ~39–46% FSTS), DAI Tier-1 (draft → JED Emerald)
✅ phân tích Singapore — Advanced I, inverted-U (TP ~82% FSTS), DAI Tier-1+2 moderation (draft → JABES Emerald/UEH)
✅ phân tích Trung Quốc China temporal 2012–2024 (draft → IJOEM)
✅ phân tích tổng hợp Meta-analysis three-level MARA k=238 (r=0.074, I²=87.8%, ICRV Q_M=17.35**) (draft → MIR)
✅ phân tích đa quốc gia Asian capstone TCI+DAI multi-country (N=82,302, TP≈37%, DAI moderation p<.01) (draft → JIBS)
✅ phân tích SIDS Thái Bình Dương Pacific SIDS Forced Penalty (REVISED, submit JED Emerald)
...
Asian capstone (all 6 ICRV groups)  → Heterogeneous moderation; phân tích đa quốc gia TP~36%, DAI≠TCI
...
*Vietnam = Nhóm IV (Lower_mid_transition, Group 4/6) nhất quán trong toàn bộ luận án (phân tích đa quốc gia code: ICRV_MAP["Vietnam"]=4; data registry: Group IV). Nhãn "Frontier V" trước đây trong phân tích Việt Nam đã được sửa thành "Nhóm IV" — nhóm V (Emerging trong phân tích đa quốc gia) là Afghanistan, Nepal, Cambodia, v.v. WGI Rule of Law Việt Nam: ~−0,66 (2009), ~−0,09 (2023), nguồn World Bank.
...
- `10_p8_pacific_sids_design_vi.md` — phân tích SIDS Thái Bình Dương boundary case
