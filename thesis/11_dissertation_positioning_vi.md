...
| Theory | Home country institutions moderates I-P | **Institutional phổ thể chế + 3 prerequisites theory** |
...
**Điểm khác biệt**: Cuervo-Cazurra single country; NCS multi-country với phổ thể chế.
...
| Theory | Institutional constraints + digital | **Full phổ thể chế** |
| DV | Export performance only | **Multiple DVs** (productivity, ROS, growth) |

**Điểm khác biệt**: Chen & Meng analyze China alone; NCS positions China within phổ thể chế rộng hơn.
...
**Điểm kết thừa**: Verbeke challenged positive DOI-FP. NCS **explains heterogeneity** that produces both positive and negative results across phổ thể chế.
...
- Đầu tiên **cumulative thesis 11 component papers (P1–P11)** với 2 đã công bố
...
|---|---|---|---|---|---|---|---|---|
| **# papers in program** | 1 | 1 | 1 | 1 | 1 | 4 | 1–3 | **11 (P1–P11)** |
...
| **Institutional phổ thể chế** | Yếu | Yếu | Yếu | Không | Một biến | Không | Không | **Full ICRV Regime I–V (6-regime CD2; 5-regime P3/P6)** |
...
> "Trong 50 năm nghiên cứu về quan hệ internationalization–firm performance, có một khoảng trống cơ bản: chưa ai test xem **inverted-U có phải universal law hay là conditional relationship**? Luận án này test điều đó bằng cách có mạch phổ thể chế từ Singapore (regime I) đến Pacific SIDS (regime extreme), và phát hiện inverted-U **không phải universal**, nó đảo dấu khi 3 prerequisites không có."
...
## 7.3 "Vì sao chưa yếu về việc có 11 component papers"
...
- 7 papers manuscripts ở various stages (P3, P4, P5, P7, P8, P10 Japan, P11 JED digital-divide)
...
Asian capstone (all 6 ICRV groups)  → Heterogeneous moderation; P7 full-model M5 TP=43.6% (M2 quadratic 51.5%), DAI≠TCI.
                                       ...
                                       không hình thành ở các regime yếu nhất (SIDS → FIP).
...
→ Vietnamese typical: 1–3 papers. NCS = 11 component papers (P1–P11).
```
