...
- **Pool phân tích đã xác minh**: K=288 effect sizes / k=238 nghiên cứu (hand-coded baseline đã xác minh, sau WoS/Scopus screening), tăng đáng kể so với bản nền ICBEF 2025 (K=200 / k=113). Đây là tập dữ liệu đã được mã hóa thủ công và tái lập được toàn bộ bảng/hình trong bản thảo P6.
