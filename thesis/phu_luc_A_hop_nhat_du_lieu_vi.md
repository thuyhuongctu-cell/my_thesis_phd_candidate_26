...
| **S5** | Phân tầng thể chế ICRV | Gán chế độ thể chế; giới hạn khung phân tích **49 nền** Á–Thái Bình Dương (gồm Nhật Bản 2025) | Khung mô tả 49 nền = **87.987** DN / 99 cặp |
| **S6** | Mẫu phân tích listwise | Loại quan sát thiếu biến phụ thuộc hoặc biến giải thích trọng tâm | Mẫu phân tích mô tả = **87.987** (49 nền); N hồi quy M2 = **80.373**; mô hình đầy đủ M5 = **78.445** |
...
flowchart TD
    ...
    F -->|"loại Comoros / Cyprus / Türkiye<br/>(ngoài Á–Thái Bình Dương); thêm Nhật Bản 2025"| G["87.987 DN, 49 nền<br/>(KHUNG PHÂN TÍCH)"]
    G -->|"S6 · listwise tập biến trọng tâm"| H["80.373, N hồi quy M2"]
    H -->|"+ đầy đủ biến kiểm soát"| I["78.445, M5 (hiệu ứng cố định hai chiều)"]
```

**Lưu ý tái lập (replication note).** Kho dữ liệu thô tái dựng được công khai trong repo
(`data_wbes/raw_dta/`, 106 sóng chuẩn từ 2006 của 49 nền, gồm Nhật Bản 2025) là **tập
...
có và cho ra dòng dữ liệu kiểm chứng; các cỡ mẫu **chính thức** của luận án trên khung 49 nền
(87.987 mẫu mô tả / 80.373 N hồi quy M2 / 78.445 M5) được ước lượng trực tiếp từ kho dữ
...
tích cuối cùng giới hạn ở **49 nền kinh tế châu Á và Thái Bình Dương** (gồm Nhật Bản 2025), loại ba nền ngoài
