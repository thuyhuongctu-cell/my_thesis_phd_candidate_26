...
| **S5** | Phân tầng thể chế ICRV | Gán chế độ thể chế; giới hạn khung phân tích **50 nền** Á–Thái Bình Dương (gồm Nhật Bản 2025) | Khung mô tả 50 nền = **88.869** DN / 103 cặp |
| **S6** | Mẫu phân tích listwise | Loại quan sát thiếu biến phụ thuộc hoặc biến giải thích trọng tâm | Mẫu phân tích mô tả = **88.869** (50 nền); N hồi quy M2 = **81.022**; mô hình đầy đủ M5 = **79.080** |
