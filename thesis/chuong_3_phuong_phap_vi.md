...
Identification, Screening, Eligibility, Inclusion theo hướng dẫn PRISMA 2020 (Page et al., 2021). Inclusion criteria: nghiên cứu thực nghiệm ở cấp doanh nghiệp, có đo lường quốc tế hóa và hiệu quả doanh nghiệp, có đủ thống kê để tính effect size (Pearson $r$, $\beta$, $t$-stat).
...
- **CSS_z_i** = DAI_z_i: chỉ số số hoá **Tầng 1 và 2**, chuẩn hóa z của trung bình(c22b₀₁, k33₀₁, k38₀₁); khác P3 ở chỗ bao gồm e-payment hai chiều (Tầng 2)
...
| NLCN_z | b8, e6 | chuẩn hóa z của TB(b8₀₁, e6₀₁) | Năng lực công nghệ (H2) |
| CSS_z | c22b, k33, k38 | chuẩn hóa z của TB(c22b₀₁, k33₀₁, k38₀₁): **Tầng 1 và 2** | Số hoá Tầng 1 và 2 (H3) |
...
*Ghi chú: CSS_z (DAI) là biến đại diện tĩnh Tầng 1 (website binary c22b). WBES không thu thập đủ thang đo cho số hoá động tại các đảo nhỏ, KHÔNG gọi là "năng lực số hoá động".*
...
| CSS_z | c22b | chuẩn hóa z(website binary): Tầng 1 only | Số hoá, biến đại diện tĩnh |
| lnLD | l1 | ln(lao động thường trực) | Control (quy mô) |
...
| phân tích tổng hợp 1982–2026 | Bausch & Krist (2007); Kirca et al. (2012); Marano et al. (2016) | Mở rộng coverage, bổ sung digital và 6 chế độ con ICRV moderators |
