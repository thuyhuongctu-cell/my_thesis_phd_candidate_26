...
Phát hiện nhất quán nhất và có ý nghĩa lý thuyết rộng nhất của luận án là **gradient ICRV (Biến thiên chế độ bối cảnh thể chế — Institutional Context Regime Variation)**: cùng một mức độ quốc tế hóa (FSTS) mang lại hiệu quả rất khác nhau tùy thuộc vào chế độ thể chế mà doanh nghiệp hoạt động. Bằng chứng từ hai nguồn độc lập hội tụ về vai trò điều tiết của thể chế: phân tích meta-analytic (P6) xác nhận hiệu ứng tổng hợp I→P **khác biệt có ý nghĩa thống kê** giữa các chế độ thể chế ($Q_M = 17{,}35$, $df = 4$, $p = {,}002$, $k = 238$), còn phân tích dữ liệu sơ cấp toàn mẫu (P7, $N = 84.910$ quan sát từ 49 nền kinh tế) thiết lập **hình dạng** của gradient: điểm ngưỡng (turning point) của quan hệ I→P **giảm dần** từ SIDS/Frontier (~55% FSTS) xuống Emerging, Upper-middle, Advanced Resource, và Advanced Innovation (~28% FSTS). Hay nói cách khác, nền kinh tế thể chế mạnh hơn đạt đỉnh hiệu quả xuất khẩu tại mức FSTS thấp hơn — doanh nghiệp không cần quốc tế hóa sâu để khai thác lợi thế cạnh tranh khi thể chế hỗ trợ đã vận hành tốt.
...
Kết quả pooled effect $r = 0{,}074$ (P6) nhất quán hoàn toàn với $r = 0{,}07$ từ meta-analysis baseline đã công bố tại hội nghị ICBEF 2024 (Do & Phan, 2024). Sự hội tụ này là đáng kể vì P6 mở rộng pool lên $k = 238$ ($K = 288$) so với $k = 113$, đồng thời áp dụng cấu trúc ba tầng phức tạp hơn. Tính vững của pooled effect khi mở rộng pool nghiên cứu là bằng chứng về tính ổn định của baseline ước lượng.

Tuy nhiên, đóng góp của P6 so với baseline không phải ở pooled $r$ mà ở cấu trúc dị biệt: phân tách $I^2 = 62{,}4\%$ cho thấy dị biệt **chủ yếu nằm ở trong từng nghiên cứu** (Tầng 2 = 54,1%) chứ không phải giữa các nghiên cứu (Tầng 3 = 8,4%) — thông tin mới mà phân tích meta đơn tầng không cung cấp. Điều này thay đổi hiểu biết về nguồn gốc của heterogeneity trong literature: các **lựa chọn đo lường và đặc tả bên trong nghiên cứu** (chứ không phải sự khác biệt bối cảnh quốc gia ổn định giữa các nghiên cứu) là nguồn chính của dị biệt. Bên cạnh đó, thiên lệch công bố đáng kể (trim-and-fill $r_{adj} = 0{,}035$) là một phát hiện riêng, gợi ý pooled effect thô có thể bị thổi phồng so với hiệu ứng dân số thực.
...
### 5.6.1 Tổng kết sáu nghiên cứu thành phần

Luận án này được xây dựng trên **sáu nghiên cứu thành phần (P3–P8)** bổ sung cho nhau, kết hợp bằng chứng từ meta-analysis và phân tích thực nghiệm sơ cấp, trên nền tảng hai công bố trước của nghiên cứu sinh:

- **Nền tảng (P1 và P2, đã công bố — ICBEF 2024, Do & Phan, 2024):** thiết lập baseline meta-analytic với $k = 113$, $r = 0{,}07$, xác nhận tác động dương nhỏ nhưng có ý nghĩa, và đặt nền cho khung CDCM. Hai công bố này là tiền đề, không tính vào sáu nghiên cứu thành phần của luận án.
...
- **P4** (Mar et al., 2026): phân tích Singapore (Advanced Innovation), xác nhận inverted-U với TP ≈ 82% (rộng CI), DAI khuếch đại tại mức FSTS cao.

- **P5** (Do & Phan, 2026f): phân tích Trung Quốc 2012–2024 (Upper-middle), xác nhận inverted-U ổn định theo thời gian (TP ≈ 48,78%, Paternoster $z = 0{,}82$, $p = {,}412$).

- **P6** (Do & Phan, 2026c): meta-analysis ba tầng mở rộng $k = 238$, $K = 288$, $r = 0{,}074$, $I^2 = 62{,}4\%$ (Tầng 2 = 54,1%, Tầng 3 = 8,4%), ICRV omnibus $Q_M = 17{,}35^{**}$ ($df = 4$, $p = {,}002$); thiên lệch công bố đáng kể (Begg $\tau = -0{,}134$, $p = {,}0007$; trim-and-fill $r_{adj} = 0{,}035$).
