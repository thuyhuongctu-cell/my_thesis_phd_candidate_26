...
- **P7** (Do & Phan, 2026d): kiểm định toàn mẫu châu Á và Thái Bình Dương với $N = 82.302$ (M2) và $N = 36.772$ (M3-M5 có đầy đủ biến kiểm soát), điểm uốn 34,1–39,5% (M2-M5; M11 đầy đủ: điểm uốn 25,7%, $p_\text{LM} = {,}026$); dải biến thiên ICRV được xác nhận mạnh mẽ, TCI nâng mặt bằng năng suất phổ quát, DAI điều tiết đường cong có ý nghĩa trên toàn mẫu và mạnh hơn ở thể chế yếu (DAI×ICRV $p = {,}049$).
