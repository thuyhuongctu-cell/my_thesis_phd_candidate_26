...
\begin{frame}{Kết quả 2: Gánh nặng quốc tế hóa bắt buộc (FIP) tại SIDS}
  \begin{columns}[T]
    ...
    Tại các nền kinh tế Pacific SIDS (Nhóm VI), phát hiện \emph{vững} trên mẫu đầy đủ tám nền ($N=1.916$, tám cụm) là \hl{sự tan rã của chữ U ngược}:
    \[ \hat\beta(\text{FSTS}^2)=+0{,}553\ (p_{wild}={,}21);\ \ \hat\beta(\text{FSTS})=-0{,}161\ (p_{wild}={,}25) \]
    \begin{itemize}
