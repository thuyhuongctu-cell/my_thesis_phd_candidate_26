...
\begin{frame}{Khung khái niệm tích hợp đa tầng CDCM (Hình 2.1)}
  \begin{columns}[T]
    ...
    \begin{tikzpicture}[
      ...
      \node[mod,fill=gray!10,draw=gray,below=1.7cm of $(i)!0.5!(p)$] (fip) {Điều kiện biên FIP (H1b) tại SIDS\\$\Rightarrow$ chữ U ngược không hình thành};
...
\begin{frame}{Hệ giả thuyết H1--H6 (+ H1b, H1c)}
  \begin{itemize}\small
    ...
    \item \kw{H1b (FIP)} --- Tại SIDS (Nhóm VI), khi cả ba điều kiện cấu trúc tối thiểu bị vi phạm, dạng chữ U ngược \hl{không hình thành} (mất cả độ cong lẫn độ dốc có ý nghĩa); quan hệ nghiêng về dạng âm đơn điệu như \emph{trường hợp giới hạn} --- \emph{gánh nặng quốc tế hóa bắt buộc}.
...
\begin{frame}{Kết quả 1: Chữ U ngược \& bức tranh ba vùng theo ICRV}
  \begin{columns}[T]
    ...
    \begin{itemize}\scriptsize
      ...
      \item Dưới (Emerging/SIDS): cấu trúc \emph{không hình thành}; FIP là trường hợp giới hạn lý thuyết.
    \end{itemize}
...
\begin{frame}{Kết quả 2: Gánh nặng quốc tế hóa bắt buộc (FIP) tại SIDS}
  \begin{columns}[T]
    ...
    Tại các nền kinh tế Pacific SIDS (Nhóm VI, bảy nền; loại Timor-Leste theo phân loại WB/UN), phát hiện \emph{vững} trên mẫu đầy đủ ($N=1.450$, bảy cụm) là \hl{việc chữ U ngược không hình thành}:
    ...
    \small \hl{FIP} là cấu trúc lý thuyết \emph{mới} --- lần đầu được định danh trong tài liệu I--P như \emph{trường hợp giới hạn} của sự không hình thành: doanh nghiệp SIDS xuất khẩu \emph{để sinh tồn}, không phải để khai thác lợi thế cạnh tranh. Ủng hộ H1b theo hướng không hình thành.
    \end{block}
    \centering
    \scalebox{0.85}{
    \begin{tikzpicture}
...
\begin{frame}{Tổng hợp kết quả kiểm định H1--H6 / H1b / H1c}
  ...
  \begin{tabular}{@{}p{1.6cm}p{4.3cm}p{6.0cm}@{}}
    ...
    H1b (FIP) & SIDS: chữ U ngược không hình thành; FIP là trường hợp giới hạn & \kw{Ủng hộ} (mẫu đầy đủ: độ cong \& độ dốc n.s.; $-1{,}339$ chỉ ở bản dựng ba cụm) \\
...
\begin{frame}{Đóng góp lý thuyết}
  \begin{enumerate}
    ...
    \item \kw{Construct mới FIP} (Forced Internationalization Penalty) --- lần đầu định danh trường hợp giới hạn nơi chữ U ngược không hình thành tại điều kiện biên cực đoan (SIDS), biện minh bằng ba điều kiện cấu trúc.
...
\begin{frame}{Kết luận}
  \begin{enumerate}
    \item Quan hệ I--P ở châu Á có dạng \hl{chữ U ngược} nhưng định hình theo \emph{ba vùng thể chế}: sắc nét ở nhóm chuyển đổi (TP $\approx 43\%$), gần tuyến tính ở thể chế mạnh nhất (gồm Nhật Bản), không hình thành ở thể chế yếu nhất.
    ...
    \item Tại \kw{SIDS}, dạng chữ U ngược không hình thành; \hl{FIP} là trường hợp giới hạn lý thuyết --- construct mới của luận án.
