...
| H5 (Dải biến thiên ICRV) | Thể chế điều tiết dải biến thiên I-P | Xác nhận: $Q_M = 17{,}35$ ($df = 4$, $p = {,}002$) từ P6 và tương tác M10 từ P7 (FSTS×ICRV $\beta = +1{,}85$; FSTS$^2$×ICRV $\beta = -2{,}93$; đều $p < {,}001$); cơ chế là độ cong/biên độ (sâu dần khi thể chế suy giảm), không phải dịch chuyển điểm uốn đơn điệu |
