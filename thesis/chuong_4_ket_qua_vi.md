...
Phân tích P7 là kiểm định quy mô lớn nhất của luận án, kết hợp toàn bộ các bối cảnh ICRV trong khu vực châu Á và Thái Bình Dương, trải dài 45 nền kinh tế và 98 đợt khảo sát quốc gia–năm. FSTS trung bình trên toàn mẫu xấp xỉ 12% (trung vị $\approx$ 0), phản ánh tình trạng đa số doanh nghiệp WBES định hướng nội địa; doanh nghiệp xuất khẩu (FSTS > 0) chiếm khoảng 18% mẫu. Tương quan giữa các biến trọng tâm đều thấp ($|r| < 0{,}15$) và hệ số phóng đại phương sai dưới 3,5, loại trừ lo ngại về đa cộng tuyến.
...
Điểm uốn dao động nhất quán trong dải hẹp 33,8–40,0% FSTS qua mọi đặc tả M2–M9, và được xác nhận lại trong mô hình điều tiết ba chiều đầy đủ M11 ($\text{TP} = 34{,}6\%$, $p_{\text{LM}} = {,}002$, $N = 28.500$). Điểm uốn tổng thể của toàn mẫu nằm vào khoảng 36% FSTS. Tính nhất quán này bác bỏ giả thuyết cho rằng đường cong U ngược chỉ là sản phẩm phụ của mẫu nhỏ hay thiếu biến kiểm soát.
