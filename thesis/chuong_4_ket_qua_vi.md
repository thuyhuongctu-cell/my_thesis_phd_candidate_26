...
Kiểm định điều tiết tổng thể về ICRV trong phân tích đa quốc gia nhất quán với kết quả phân tích tổng hợp ở phân tích tổng hợp ($Q_M = 17{,}35$, $p = {,}002$). Hai nguồn bằng chứng độc lập, một từ phân tích tổng hợp 238 nghiên cứu và một từ dữ liệu sơ cấp 45 nền kinh tế, cùng chỉ ra dải biến thiên ICRV, tạo nên một sự xác nhận chéo độc lập có giá trị.
...
| H5 (Dải biến thiên ICRV) | Thể chế điều tiết dải biến thiên I-P | Xác nhận: $Q_M = 17{,}35$ ($df = 4$, $p = {,}002$) từ phân tích tổng hợp và tương tác M10 từ phân tích đa quốc gia (FSTS×ICRV $\beta = +1{,}85$; FSTS$^2$×ICRV $\beta = -2{,}93$; đều $p < {,}001$); cơ chế là độ cong/biên độ (sâu dần khi thể chế suy giảm), không phải dịch chuyển điểm uốn đơn điệu |
