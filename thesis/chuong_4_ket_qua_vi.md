...
Điểm turning point trong khoảng **39–46% FSTS** đặt Việt Nam ở mức "thấp hơn đáng kể" so với Singapore (TP ≈ 88,6%) và tương đương hoặc thấp hơn Trung Quốc (TP ≈ 48,78%). Kiểm định Paternoster so sánh turning point giữa 2009 và 2015 cho kết quả $z = 3{,}353$, $p < {,}001$, có ý nghĩa thống kê. Turning point đã dịch chuyển đáng kể từ 46,2\% xuống 39,3\% giữa hai làn sóng.
