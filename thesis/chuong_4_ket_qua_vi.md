...
Kiểm định Egger cho kết quả $p = {,}31$ (không có ý nghĩa thống kê), tức không có bằng chứng về publication bias trong tập hợp 238 nghiên cứu. Phân tích trim-and-fill điều chỉnh ước lượng hiệu ứng từ $r = 0{,}074$ xuống $r = 0{,}035$ — mức điều chỉnh nhỏ và không làm thay đổi bất kỳ kết luận nào về chiều hướng hay ý nghĩa của quan hệ tổng hợp.
