#!/usr/bin/env python3
"""
Comprehensive SDMX Metadata Downloader

Downloads complete metadata catalogs from all SDMX data providers:
...
Based on https://sdmx1.readthedocs.io/en/latest/sources.html
"""
...
class SDMXMetadataDownloader:
    ...
    # Priority providers for economic data
    PRIORITY_PROVIDERS = [
        'IMF',           # International Monetary Fund
        'WB',            # World Bank (if available)
