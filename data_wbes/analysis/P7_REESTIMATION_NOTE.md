...
- DV = năng suất lao động **z-chuẩn hóa within country-year** (`lp_z`) — loại artifact tiền tệ (ln_labor_prod thô dao động -4,2 đến 29,7 do nội tệ trộn).
...
| Nhóm ICRV | TP tái lập (script) | TP P7 công bố (Ch4 Mục 4.6) |
|---|--:|--:|
...
| **Pooled** | **52%** | **40,0% (M5)** |
 ...
 đến Gradient **ngược chiều** (P7: tăng I–V; tái lập: I cao nhất) và SIDS sai dạng. Sai lệch lớn & có hệ thống.
...
- **Tác động đếm (chắc chắn)**: thêm Japan-2025 đến khung phân loại 49 nền (91.864 DN) thành **50 nền (94.032 DN)**; Nhóm I 4.222 đến 6.390.
- **Hồ sơ mô tả Japan** (xem `DATA_UPDATE_MANIFEST.md` Mục 3): website 83,8%, DN ~50 tuổi, FSTS 4,1% (quốc tế hóa thấp).
- **Footnote minh bạch** đã thêm vào: Chương 4 Mục 4.6.1 + CĐ1 (Mục 2.3.2 ghi chú) — nêu rõ Japan + sóng mới lưu trữ cho vòng ước lượng lại; **kết quả P7 báo cáo giữ trên mẫu 49 nền đã khóa**.
...
Khi nhóm tác giả chạy `do`-file P7 gốc trên bộ raw mở rộng (49 nền + Japan + sóng ≥2024 trong `data_wbes/raw_dta/`), rồi thay turning point/hệ số mới vào Mục 4.6. Cho tới lúc đó, luận án giữ số P7 đã khóa.
