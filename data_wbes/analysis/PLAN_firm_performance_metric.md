...
> thống kê mô tả theo nhóm ICRV (CĐ1 §2.3.3–2.3.8, Chương 4 §4.1) **nhất quán với
...
| **P2 — JFAR** (đã đăng) | Trung Quốc (SME) | **Năng suất lao động** | **ROA**, Sales Growth (Bảng 5) | 1 nước → so sánh được |
| **Book chapter — InTechOpen** (đã đăng) | Ấn Độ | **ROS** (Return on Sales) | — | 1 nước → so sánh được |
| **P3–P9 (luận án)** | 1 nước hoặc 49 nước | Năng suất lao động (FSTS→LP) | — | dùng country-year FE |

→ Hai trục đo chuẩn của nhóm tác giả: **năng suất lao động** (P1, P2, P7) và **ROS/ROA** (book chapter, P2 robustness).
...
Việt Nam "năng suất cao nhất" chỉ là **ảo giác đơn vị tiền tệ**. ⇒ **Không được** dùng
...
2. **ROS = lợi nhuận/doanh thu** — chỉ số PHỤ (tỷ lệ, vô đơn vị → so sánh được trực tiếp).
...
| # | Việc | Nguồn | Output |
|---|---|---|---|
| 1 | Xác nhận P1 quy đổi USD hay within-region (đọc kỹ P1 §3.2) | `p1/*.docx` | ghi chú metric |
...
| 5 | Cập nhật CĐ1 §2.3.3–2.3.8 + Chương 4 §4.1; trích P1/P2/book chapter | bước 4 | re-lock |
