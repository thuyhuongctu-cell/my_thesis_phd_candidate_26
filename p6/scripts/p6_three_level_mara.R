...
# P6 UPDATED target: k=194 studies, K≈320 effect sizes (extended backward scan + 2022–2026)
...
# k=194 studies, K≈320 effect sizes (three-level: multiple ES per study)
# ICBEF 2025 baseline was k=113; P6 adds 81 studies via backward scan (Kirca/Marano/Wu) + 2022–2026 (incl. S176–S194)
n_studies   <- 194
...
cat("  [ICBEF 2025 baseline: k=113, r=0.07 → P6 target: k=194 — synthetic data]\n\n")
