...
2. Nhấn **Export** đến **Excel** (hoặc Plain Text)
...
> Dùng `internationaliz*` và `internationalis*` để bắt toàn bộ dạng từ (xem ghi chú Mục 1.2).
...
1. Chọn **tất cả** đến **Export** đến **CSV / Excel**
...
3. Dùng Excel: **Data đến Remove Duplicates** (cột DOI)
...
|---|-----------|-------------------|
| 1 | Không xét mối quan hệ I đến FP | not_IP |
...
- Mẫu trùng với bài đã có đến giữ bài **n lớn hơn** hoặc **mới hơn**
