...
5. Double-entry verify each extracted row: re-enter `r`, `n` and moderator codes, reconcile against the source PDF (single-coder design — no inter-coder κ; see manuscript §3.3.2)
