...
## [7.0.0] — 2026-06-08
- Two-tab workflow finalised: **Extract** (LLM PDF → effect sizes) and
...
- CSV export restricted to `pi_locked=True` records → `forest_data.csv`,
...
- v6.x — extraction-hierarchy conversion (t/F/β → Pearson r) hardening.
