...
**Target journal:** Journal of World Business (JWB), Elsevier
...
- **Đỗ Thùy Hương:** Conceptualization, Methodology, Data curation, Formal analysis, Writing – original draft.
- **Phan Anh Tú:** Conceptualization, Supervision, Validation, Writing – review & editing.

## Declarations
- **Funding:** None.
- **Conflict of interest:** The authors declare no competing interests.
- **Data availability:** The coded study database and analysis scripts are available from the corresponding author on reasonable request; PRISMA materials are provided as supplementary files.
