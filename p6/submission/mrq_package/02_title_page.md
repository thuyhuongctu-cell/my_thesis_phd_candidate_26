...
Target journal: *Management Review Quarterly* (Springer; Scopus Q1)
Submission: Q4 2026
...
The coded study database, R replication scripts (metafor) with an independent Python cross-check, the PRISMA flow diagram, and the extraction codebook are openly available via the project's Open Science Framework (OSF) record: https://osf.io/z37kn (DOI: 10.17605/OSF.IO/Z37KN). The OSF pre-registration was lodged prior to effect-size extraction.
...
| Word count | Approximately 14,900 words incl. appendices (MRQ accommodates review length) |
| Studies (*k*) | 238 (verified baseline corpus) |
| Effect sizes (*K*) | 288 |
| Economies | 49 |
| Tables | 5 (+ appendices) |
| Figures | 5 (conceptual model; ICRV forest; DPL phase; leave-one-out sensitivity; funnel plot) |
