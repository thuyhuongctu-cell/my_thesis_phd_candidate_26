# Canonical Author Record — PhD Dissertation Papers

> Single source of truth for all journal submissions in this dissertation.
> Reference this file when creating or updating cover letters and title pages.
...
| Field | Value |
|---|---|
| Vietnamese name | Đỗ Thùy Hương |
| Romanised name | Do Thuy Huong |
| Citation name | Do, T. H. |
...
| Field | Value |
|---|---|
| Vietnamese name | Phan Anh Tú |
| Romanised name | Phan Anh Tu |
| Citation name | Phan, A. T. |
...
| ORCID URL | https://orcid.org/0000-0003-0667-3137 |

---

## Standard CRediT Contribution Table

Applies to all empirical papers (P3 Vietnam, P4 Singapore, P5 China, P6 meta-analysis).
...
| P4 Singapore | JABES (Journal of Asian Business and Economic Studies, Emerald on behalf of UEH) | Submission ready | p4_singapore_cover_letter.md/.docx | p4_singapore_title_page.md/.docx |
