...
- **P6 data pipeline regenerated** (16/05/2026): p6_study_database.csv (K=287/k=237, was stale at K=285/k=235) and all 5 result tables regenerated by running p6_parse_database.py then p6_real_mara.R. ⚠️ CRITICAL DISCREPANCY FLAGGED: actual MARA results differ substantially from manuscript's "pre-formal-search simulation estimates" — requires user review before manuscript results section can be finalized:
  - Baseline r: actual 0.074 [0.060, 0.088] vs manuscript 0.075 [0.061, 0.089] (minor rounding)
  - ICRV gradient: actual I=0.079 (k=139), II=0.065 (k=25), III=0.068 (k=90), FR=0.349 (k=3, driven by Pouresmaeili et al. r=0.69 outlier), MX=0.053 (k=30); Q_M=126.53 — vs manuscript simulation I=0.21, FR=−0.02; gradient direction partially contradicted (FR only k=3 studies, unstable)
  - DPL ordering: actual PRE=0.082 > FOL=0.073 > SPN=0.068 (Q_M=103.15) vs manuscript prediction FOL > SPN > PRE — ordering reversed
