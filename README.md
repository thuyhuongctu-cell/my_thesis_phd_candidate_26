...
```bash
# 1) Hợp nhất .dta thô thành tệp phân tích (50 nền Asia-Pacific, gồm Japan-2025, loại Timor-Leste)
...
- **Phạm vi phân tích:** loại các điều tra phi chính thức/siêu nhỏ/ISES; loại Comoros (Ấn Độ Dương) và Timor-Leste (Đông Nam Á) khỏi **nhóm SIDS của nghiên cứu P8** (P7 vẫn giữ Timor như nền Đông Á–TBD).
...
|---|--:|--:|
| **P7** điểm uốn M2 / M5 | 51,5% / 43,6% | 51,5% / 43,6% |
| P7 độ cong β₂ (M2) | −1,399 | −1,398 |
