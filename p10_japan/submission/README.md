...
Numbers source: estimated on Japan-2025-full-data.dta (pyfixest, HC1, sector FE);
re-validate with Stata do-file before submission per docs/STATA_TRONG_CLAUDE_CODE.md.
