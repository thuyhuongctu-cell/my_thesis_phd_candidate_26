...
> 2. **Hán-Việt vừa phải**: giữ Hán-Việt phổ biến chuẩn (thịnh vượng, dị biệt, hệ quả); chỉ thay những từ ít dùng hoặc khó hiểu (phồn vinh đến thịnh vượng; chồng lấn đến đan xen).
...
>
> **Phiên bản 1.2 (07/05/2026 cuối phiên — Bổ sung Nhóm 7 thuật ngữ WBES methodology + Asia-Pacific structural)**: Thêm **Nhóm 7 — Thuật ngữ WBES methodology + Asia-Pacific (8 mục)** phục vụ Phase 4 sub-commits (file 14 v3.10 Mục 1.3+Mục 1.4 WBES official; file 15 v3.8 Mục 4.4+Mục 4.5+Mục 4.7 4 rào cản + Bribery/Graft phân biệt; file 16 v3.5 Mục 5.7 PICs macro context). Tổng 68 mục thuật ngữ trong 7 nhóm.
>
> **Phiên bản 1.3 (13/05/2026 — Bổ sung CDCM + Sửa ngưỡng FY2026)**: Thêm **CDCM (Context-Contingent Digital Capability Model)** vào Nhóm 2 (#20a) — construct trung tâm của CĐ2 H2–H3. Cập nhật ngưỡng phân loại thu nhập WB FY2026 tại mục #60 theo xác nhận chính thức (hiệu lực 01/07/2025): Thu nhập thấp ≤$1.145, LMI $1.146–$4.515, UMI $4.516–$14.005, HI >$14.005. Cập nhật Checklist từ 12 đến **13 điểm**. Tổng: **69 mục** thuật ngữ trong 7 nhóm (11+10+10+10+10+10+8).
>
> **Phiên bản 1.4 (14/05/2026 — Audit + bổ sung 6 mục IB/kinh tế lượng cốt lõi)**: Sau rà soát chéo P3/P4/P5 manuscripts. Bổ sung #30a-b (Nhóm 3): đặc tả bậc hai, kiểm định Lind–Mehlum. Bổ sung #40a-d (Nhóm 4): inverted-U, turning point, I–P relationship, log labour productivity. Tổng: **75 mục** trong 7 nhóm.
...
- [B. Bảng thuật ngữ Anh-Việt (75 mục, 7 nhóm)](#b-bảng-thuật-ngữ-anh-việt-75-mục-7-nhóm)
- [C. Năm anti-patterns thường gặp (trước đến sau)](#c-năm-anti-patterns-thường-gặp-trước--sau)
- [D. Checklist 13 điểm tự kiểm tra trước khi nộp](#d-checklist-13-điểm-tự-kiểm-tra-trước-khi-nộp)
...
**Mẹo ngắt câu**:
- Liệt kê 4+ phần tử đến tách thành câu mở (giới thiệu) + câu liệt kê.
- Mệnh đề "với tác động..." đến tách thành câu sau dùng "Tác động này...".
- Liên kết "và", "đồng thời", "cùng với" liên tiếp đến cảnh báo câu sắp dài.
...
**Ví dụ đoạn chuẩn (Chương 4, Mục 4.2)**:
...
## B. Bảng thuật ngữ Anh-Việt (75 mục, 7 nhóm — cập nhật v1.4)

### Nhóm 1 — Khái niệm cốt lõi (10 mục)

| # | Tiếng Anh | Tiếng Việt khuyến nghị | Cách dùng lần đầu | Ghi chú |
|---|---|---|---|---|
| 1 | pool (data pool) | nhóm dữ liệu / tổng hợp dữ liệu | "nhóm dữ liệu (pool) 101.185 doanh nghiệp" | Tránh "pool" trần |
...
| 7 | observation | quan sát | "n=101.185 quan sát" | Quá phổ biến |
...
### Nhóm 2 — Construct và Index (11 mục)
...
| 20a | CDCM (Context-Contingent Digital Capability Model) | Mô hình năng lực số ngữ cảnh | "Mô hình năng lực số ngữ cảnh (Context-Contingent Digital Capability Model — CDCM)" | Đỗ & Phan (2026 — CĐ2); Verhoef et al. (2021) 4-Tier; **phân biệt**: DAI đo mức *áp dụng* số (adoption), CDCM đo *chiều sâu năng lực số* theo ngữ cảnh ICRV — construct trung tâm của H2 và H3 |

### Nhóm 3 — Thống kê và phương pháp định lượng (12 mục — cập nhật v1.4)
...
| 30a | quadratic specification / quadratic term | đặc tả bậc hai / số hạng bậc hai | "đặc tả bậc hai (quadratic specification): FSTS + FSTS²" | Dùng "bậc hai" hoặc "phi tuyến bậc hai"; TRÁNH "hồi quy bậc hai" (sai về thuật ngữ) |
| 30b | Lind–Mehlum test | kiểm định Lind–Mehlum | "kiểm định Lind–Mehlum (2010) xác nhận hình chữ U ngược thực sự (true inverted-U)" | Sasabuchi upper bound + Extreme point test; Stata: utest; R: lind.mehlum |

### Nhóm 4 — IB-specific và phương pháp luận quốc tế (14 mục — cập nhật v1.4)
...
| 40a | inverted-U relationship | quan hệ hình chữ U ngược | "quan hệ hình chữ U ngược (inverted-U) giữa I và P" | Hitt et al. (1997); sau lần đầu: "hình chữ U ngược" hoặc "quan hệ phi tuyến I–P" |
| 40b | turning point | điểm ngưỡng / điểm uốn | "điểm ngưỡng (turning point) của hình chữ U ngược tại FSTS ≈ 40%" | Dùng "điểm ngưỡng" (chuẩn) hoặc "điểm uốn" (toán học); TRÁNH "điểm ngoặt" (narrative) |
| 40c | internationalization–performance (I–P) | quan hệ quốc tế hóa–hiệu quả | "quan hệ quốc tế hóa–hiệu quả (internationalization–performance — I–P)" | Viết tắt I–P sau lần đầu; lưu ý: gạch nối en-dash "–" không phải hyphen "-" |
| 40d | log labour productivity | logarithm năng suất lao động | "logarithm năng suất lao động — ln(d2/l1), được winsorize ở mức 1/99" | Biến phụ thuộc cốt lõi P3/P4/P5; "năng suất lao động" sau lần đầu |
...
| 60 | 4 income groups | **4 nhóm thu nhập**: Thu nhập thấp / Thu nhập trung bình thấp / Thu nhập trung bình cao / Thu nhập cao | "Phân loại 4 nhóm thu nhập theo World Bank FY26: Thu nhập thấp ≤$1.145 GNI; Thu nhập trung bình thấp $1.146–$4.515; Thu nhập trung bình cao $4.516–$14.005; Thu nhập cao >$14.005" | WB FY26 Country Classification (hiệu lực 01/07/2025) — **cập nhật v1.3**: ngưỡng chính thức xác nhận, sửa từ ước tính v1.2 ($1.135/$4.495/$13.935) |
...
> **Nguồn**: World Bank (n.d.). *Tài liệu tóm tắt: Các chỉ số khảo sát doanh nghiệp Enterprise Surveys* + World Bank (2025). *Hướng dẫn học tập: Hệ thống phân loại quốc gia FY26*. Phục vụ Phase 4 sub-commits: file 14 v3.10 (Mục 1.3+Mục 1.4 methodology), file 15 v3.8 (Mục 4.4+Mục 4.5+Mục 4.7 4 rào cản + Bribery/Graft), file 16 v3.5 (Mục 5.7 PICs macro). Cited file 04 v2.5 (commit a3c1769).

| # | Tiếng Anh | Tiếng Việt CHUẨN | Cách dùng lần đầu | Nguồn / Ghi chú |
|---|---|---|---|---|
| 61 | Top 4 barriers WBES Asia-Pacific | **4 rào cản hàng đầu** đối với khu vực tư nhân Á-Thái: (i) tiếp cận tài chính; (ii) lao động thiếu kỹ năng; (iii) cạnh tranh từ doanh nghiệp phi chính thức; (iv) nguồn cung điện không đáng tin cậy | "4 rào cản hàng đầu (top 4 barriers) đối với khu vực tư nhân Á-Thái theo WBES" | Phục vụ Mục 4.5.5 file 15 v3.8a |
| 62 | WBES size classification | **Phân loại quy mô WBES**: Nhỏ (5-19 lao động) / Vừa (20-99) / Lớn (100+) / Rất lớn (top 1% nền kinh tế) | "Phân loại quy mô WBES: Nhỏ (5-19), Vừa (20-99), Lớn (100+), Rất lớn (top 1%)" | WB Indicators Summary; phục vụ Mục 1.3 file 14 v3.10a |
| 63 | Sampling weights | **Trọng số lấy mẫu** | "trọng số lấy mẫu (sampling weights) áp dụng cho mọi mean/median" | WB Indicators Summary; phục vụ Mục 1.4 file 14 v3.10b |
| 64 | Bribery Incidence | **Tỷ lệ hối lộ** | "Tỷ lệ hối lộ (Bribery Incidence) — tỷ lệ DN nhận yêu cầu hối lộ trong 6 giao dịch công" | WB Indicators Summary; phục vụ Mục 4.7 file 15 v3.8c |
| 65 | Bribery Depth | **Độ sâu hối lộ** | "Độ sâu hối lộ (Bribery Depth) — tỷ lệ giao dịch công có hối lộ trên tổng giao dịch" | WB Indicators Summary; phục vụ Mục 4.7 file 15 v3.8c |
| 66 | Graft Index | **Chỉ số tham ô** | "Chỉ số tham ô (Graft Index) — tỷ lệ hối lộ gồm kết nối điện thoại nhưng loại trừ thanh tra thuế" | WB Indicators Summary; phục vụ Mục 4.7 file 15 v3.8c |
| 67 | PICs (Pacific Island Countries) | **Quốc đảo Thái Bình Dương** (PICs) | "Quốc đảo Thái Bình Dương (Pacific Island Countries — PICs) — 6 nền kinh tế nhỏ Pacific" | Bertram (2006); phục vụ Mục 5.7 file 16 v3.5a |
| 68 | WBES excluded sectors | **4 ngành loại trừ khỏi WBES**: tiện ích công cộng / dịch vụ chính phủ / chăm sóc sức khỏe / dịch vụ tài chính | "4 ngành loại trừ khỏi vũ trụ khảo sát WBES: tiện ích công cộng, dịch vụ chính phủ, chăm sóc sức khỏe và dịch vụ tài chính" | WB Indicators Summary; phục vụ Mục 1.3 file 14 v3.10a |

**Liên kết nội dung phục vụ Phase 4 sub-commits**:
- **#62 + #68** đến file 14 Mục 1.3 (sub-commit 1A v3.10a) — thiết lập đối tượng nghiên cứu chuẩn WBES.
- **#63** đến file 14 Mục 1.4 (sub-commit 1B v3.10b) — methodology trọng số lấy mẫu + ngưỡng quan sát.
- **#61** đến file 15 Mục 4.5.5 (sub-commit 2A v3.8a) — mini-section 4 rào cản.
- **#64 + #65 + #66** đến file 15 Mục 4.7 (sub-commit 2C v3.8c) — phân biệt Bribery Incidence vs Depth vs Graft.
- **#67** đến file 16 Mục 5.7 (sub-commit 3A v3.5a) — Pacific PICs macro context với MIRAB model.
...
## C. Năm anti-patterns thường gặp (trước đến sau)

### Anti-pattern 1 — Code-switching không giải thích

**Trước**: *"Pool 101.185 doanh nghiệp xuyên 47 nền kinh tế cho thấy dispersion lớn về productivity."*

**Sau**: *"Nhóm dữ liệu (pool) 101.185 doanh nghiệp xuyên 47 nền kinh tế cho thấy phân tán (dispersion) lớn về năng suất."*
...
**Lý do**: 1 câu 78 từ với 5 phần tử + chi tiết đến khó theo dõi. Tách thành câu mở (giới thiệu) + câu liệt kê + câu nhấn mạnh điểm mới.
...
**Mapping**:
- "đầu kéo" (chuyên ngành đường sắt) đến "động lực" (kinh tế chuẩn)
- "phồn vinh" (cổ điển) đến "thịnh vượng" (hiện đại + chuẩn World Bank "prosperity")
- "chồng lấn" (chuyên ngành luật) đến "đan xen" (chuẩn) hoặc "chồng chéo" (chuẩn)
...
**Lý do**: Lặp "Singapore" 4 lần + 4 câu rời rạc đến 1 câu mở + 1 câu phân tích, đa dạng cấu trúc.

---

## D. Checklist 13 điểm tự kiểm tra trước khi nộp

Sau khi viết xong một chương hoặc một mục, NCS rà soát 13 điểm sau:
...
- [ ] **(2) Acronym** — Mọi acronym đều có giải thích đầy đủ ở lần đầu (vd: "Năng lực số (Digital Adoption Index — DAI)"; "Mô hình năng lực số ngữ cảnh (Context-Contingent Digital Capability Model — CDCM)"; "Biến thiên chế độ thể chế (Institutional Context Regime Variation — ICRV)").
...
- [ ] **(9) Số liệu** — Số thập phân dùng dấu phẩy ("0,86" không "0.86"); phần nghìn dùng dấu chấm ("101.185" không "101,185"); đơn vị viết đầy đủ lần đầu (USD PPP, đơn vị phần trăm — đpt).
...
- [ ] **(13 — mới v1.3) Acronym CDCM** — Khi CDCM xuất hiện lần đầu trong CĐ2 hoặc bản dịch P3/P4: dùng "Mô hình năng lực số ngữ cảnh (Context-Contingent Digital Capability Model — CDCM)". Phân biệt rõ CDCM (chiều sâu năng lực theo ngữ cảnh ICRV) với DAI (mức độ áp dụng số) — đây là hai construct riêng biệt phục vụ H2 và H3 trong CĐ2.
...
*Phiên bản 1.2 (07/05/2026 cuối phiên) — Bổ sung Nhóm 7 (8 mục) thuật ngữ WBES methodology + Asia-Pacific structural từ World Bank Vietnamese sources. Tổng glossary: **68 mục thuật ngữ trong 7 nhóm** + 5 conventions + 5 anti-patterns + **12-điểm checklist** + 12 references về văn phong KH Việt. Phục vụ Phase 4 sub-commits: file 14 v3.10 (Mục 1.3 phân loại quy mô + Mục 1.4 sampling), file 15 v3.8 (Mục 4.4 + Mục 4.5 + Mục 4.7 4 rào cản + Bribery/Graft), file 16 v3.5 (Mục 5.7 PICs macro). Liên kết file 04 v2.5 (commit a3c1769) + file 14 v3.10 (commit 9c512b3).*

*Phiên bản 1.4 (14/05/2026) — Audit và bổ sung 6 mục còn thiếu, kết quả rà soát chéo với P3/P4/P5 manuscripts và CĐ1. **Bổ sung vào Nhóm 3**: #30a quadratic specification (đặc tả bậc hai), #30b kiểm định Lind–Mehlum. **Bổ sung vào Nhóm 4**: #40a inverted-U relationship (quan hệ hình chữ U ngược), #40b turning point (điểm ngưỡng), #40c I–P relationship (quan hệ quốc tế hóa–hiệu quả), #40d log labour productivity (logarithm năng suất lao động). **Tổng: 75 mục** trong 7 nhóm. Audit kết quả: Không có "marginally significant" trong P3/P4/P5; N consistency đạt (P3=2.958, P4=623, P5=2.610/1.934/4.544); Blind review compliant; Data availability statements đầy đủ. Xem Submission Check report trong commit message.*

*Phiên bản 1.3 (13/05/2026) — Bổ sung CDCM (#20a) vào Nhóm 2: construct "Mô hình năng lực số ngữ cảnh (Context-Contingent Digital Capability Model — CDCM)" trung tâm của CĐ2 H2–H3, phân biệt với DAI (áp dụng số) vs CDCM (chiều sâu năng lực). Sửa ngưỡng WB FY2026 tại mục #60: ước tính v1.2 ($1.135/$4.495/$13.935) đến giá trị chính thức xác nhận ($1.145/$4.515/$14.005, hiệu lực 01/07/2025). Cập nhật Checklist 12 đến **13 điểm** (thêm mục 13: CDCM first-mention). Tổng glossary: **69 mục thuật ngữ trong 7 nhóm (11+10+10+10+10+10+8)** + 5 conventions + 5 anti-patterns + **13-điểm checklist** + 12 references về văn phong KH Việt.*
