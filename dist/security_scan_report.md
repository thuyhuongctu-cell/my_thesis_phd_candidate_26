...
wos_api_key:
  ...
  required: false
  default: '1a0367***REDACTED-ROTATE-REQUIRED***'
```
...
3. Trích xuất API key `1a0367***REDACTED-ROTATE-REQUIRED***`
...
scopus_api_key:
  ...
  required: false
  default: '5a33a2***REDACTED-ROTATE-REQUIRED***'
```
...
openalex_api_key:
  ...
  required: false
  default: 'WV8Ajx***REDACTED-ROTATE-REQUIRED***'
```
