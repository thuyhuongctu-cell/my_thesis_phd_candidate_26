...
(\(\beta = −0.404\), p = 0,032 trong mô hình hiệu ứng cố định quốc
gia-năm; \(\beta = −1.236\), p \textless{} 0,001 khi không có hiệu ứng
cố định quốc gia), không có độ cong bậc hai có ý nghĩa thống kê.
...
0,052). Sở hữu nước ngoài cho thấy quan hệ âm ở mức biên
(\(\beta = −0.006\), p = 0,056), có thể phản ánh hiệu quả đầu tư nước
ngoài thấp trong bối cảnh SIDS. Quy mô doanh nghiệp dương nhưng không có
ý nghĩa thống kê (β = +0,082, p = 0,242).
...
Hệ số FIP (FSTS\_c) vẫn âm nhưng mất ý nghĩa thống kê trong M3
(\(\beta = −0.974\), p = 0,252), có khả năng phản ánh mẫu giảm đáng kể
(N = 526 cho M3, so với N = 1.469 cho M1, do các biến năng lực bị
thiếu). Chiều hướng của hệ số FSTS\_c vẫn âm và về số học lớn hơn trong
M3, nhất quán với FIP; sự mất ý nghĩa thống kê có thể quy cho việc giảm
năng lực thống kê từ hạn chế mẫu con.
...
\(\beta = −0.404\), p = 0,032). (ii) không có độ cong bậc hai hay điểm
ngưỡng có ý nghĩa thống kê (M2: cả FSTS\_c lẫn FSTS\_c² đều không có ý
nghĩa thống kê). (iii) âm vững chắc trên bốn đặc tả (M\_yearFE:
\(\beta = −1.236\), p \textless{} 0,001; M\_bivariate:
\(\beta = −1.596\), p \textless{} 0,001; chỉ nhà xuất khẩu:
\(\beta = −0.901\), p = 0,027). (iv) điều tiết năng lực null (M3: TCI\_z
p = 0,495; DAI\_z p = 0,402).
...
trên bốn đặc tả thực nghiệm (\(\beta = −0.404\), p = 0,032 trong mô hình
hiệu ứng cố định quốc gia-năm chính; \(\beta = −1.236\), p \textless{}
0,001 không có hiệu ứng cố định quốc gia; \(\beta = −0.901\), p = 0,027
trong mẫu con chỉ nhà xuất khẩu). Hạng tử bậc hai không có ý nghĩa thống
kê, xác nhận dạng âm đơn điệu, không có điểm ngưỡng trong phạm vi quan
sát. Chỉ số năng lực công nghệ (TCI) và Chỉ số áp dụng số (DAI), vốn có
ý nghĩa thống kê trong các bối cảnh châu Á đại lục, lại null trong môi
trường SIDS, nhất quán với cơ chế lý thuyết FIP.
...
chỉ nhà xuất khẩu (\(\beta = −0.901\)) giải quyết lo ngại lựa chọn bất
lợi: trong số các nhà xuất khẩu tích cực, tăng cường xuất khẩu thêm làm
xấu đi hiệu quả.}
