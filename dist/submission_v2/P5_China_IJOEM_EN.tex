...
.010), and FSTS² carries a negative coefficient in both waves (2012:
\(\beta = −1.53\), SE = 0.42, p \textless{} .001; 2024:
\(\beta = −1.58\), SE = 0.50, p = .002); this positive linear and
negative quadratic pattern is consistent with an inverted-U relationship
in both waves, consistent with H1. Following Haans, Pieters, and He
(2016), all four formal conditions for a genuine inverted-U are
satisfied in both waves. For the 2012 wave: (C1) β₁ = +1.28 (p = .001),
confirming a positive ascending limb; (C2) β₂ = −1.53 (p \textless{}
.001), confirming concavity; (C3) the turning point TP* = 49.4\% lies
...
the 2024 wave (β₁ = +1.19, β₂ = −1.58, TP* = 47.2\%, LM p \textless{}
.001) and the pooled specification.
...
and FSTS² \(\beta = −1.55\) (p \textless{} .001), with turning point at
48.8\,\% (95\,\% CI: 44.2--53.4\,\%).
