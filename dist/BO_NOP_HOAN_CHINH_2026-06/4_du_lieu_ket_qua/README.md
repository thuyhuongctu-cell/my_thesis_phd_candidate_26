...
- `P3..P10_results_workbook.xlsx` — workbook kết quả riêng cho **từng paper P3–P10**
  (hệ số ước lượng, turning point, kiểm định, dữ liệu hình/bảng). P9 gồm 10 sheet
  (3 đợt 2014/2022/2025, điểm uốn, U-test, điều tiết, độ vững); P10 gồm estimates
  tái lập + đối chiếu canonical (M1/M2, export premium, mô tả; N=2.168).
