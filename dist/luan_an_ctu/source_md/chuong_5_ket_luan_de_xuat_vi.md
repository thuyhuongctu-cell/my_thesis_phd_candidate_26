...
- **P8** (World Development under revision, Đỗ & Phan, 2026): phân tích SIDS, $N = 1.469$, $\beta(\text{FSTS}_c) = -0{,}404^{*}$, FIP xác nhận — quan hệ âm đơn điệu không có turning point.
