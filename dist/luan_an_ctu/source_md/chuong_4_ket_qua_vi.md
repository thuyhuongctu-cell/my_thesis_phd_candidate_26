...
*Ghi chú: Bảng 4.2 tái tính trực tiếp từ dữ liệu thô WBES trên khung 49 nền (dedupe theo nước–năm, đợt ≥2006; chỉ báo h1/h5/h8/b8/c22b), nay tách đủ sáu nhóm — Nhóm II (GCC) đủ 6/6 nền nên không còn phải gộp vào Advanced như bản trước. "Quy trình mới" dùng định nghĩa chuẩn h5 (hẹp hơn bản khóa mô tả cũ). Bộ số này khớp Bảng 2.3.4.1 của Chuyên đề 1 (`data_wbes/analysis/CD1_PIPELINE_RESULTS.md`). Gradient năng lực thể chế thể hiện rõ ở các biến nền tảng: R&D 20,5% (Nhóm I) → 10,2% (Nhóm VI); ISO 35,0% → 12,2%; website 61,7% → 41,5%.*
