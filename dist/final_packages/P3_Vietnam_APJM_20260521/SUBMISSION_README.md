# P3_Vietnam_APJM — Submission Package
...
| File | Format | Purpose |
|---|---|---|
| `P3_Vietnam_APJM_manuscript_EN.docx` | DOCX | Primary submission file (most journals require this) |
| `P3_Vietnam_APJM_manuscript_EN.pdf` | PDF | Preview / reference copy |
| `P3_Vietnam_APJM_manuscript_EN.tex` | LaTeX | Source for journals that accept LaTeX |
| `P3_Vietnam_APJM_manuscript_VN.docx` | DOCX | Vietnamese version for CTU thesis dossier |
| `P3_Vietnam_APJM_manuscript_VN.pdf` | PDF | Vietnamese preview |
...
3. Upload to the journal's submission portal:
   - **Asia Pacific Journal of Management (APJM)**: see journal's submission guidelines page.
