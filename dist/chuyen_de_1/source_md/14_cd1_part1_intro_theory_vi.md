...
3. Phân tích thực trạng đa chiều hiệu quả hoạt động kinh doanh ở **41 nước châu Á (scope chính)** + so sánh với 7 SIDS Pacific (boundary case);
...
**Mô hình Áp dụng số và Năng lực phụ thuộc bối cảnh (Context-Contingent Digital-and-Capability Model — CDCM)** — đóng góp lý thuyết MỚI hợp nhất hai papers:
