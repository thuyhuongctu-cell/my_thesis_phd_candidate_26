...
description: >
  ...
  comprehensive "Signs of AI writing" guide. Detects and fixes 22+ patterns
  ...
  words, copula avoidance, passive voice, negative parallelisms, false ranges,
  elegant variation, inline-header vertical lists, title-case headings, filler
  phrases, and "soulless writing" detection. Complements the existing
  phd-academic-writing-humanizer (em-dash focus) and stop-slop (AI tells)
  skills by providing the most comprehensive pattern coverage. For academic
  manuscripts (dissertation chapters, P3–P8 papers), apply alongside the
  Vietnamese-specific academic humanizer skills already installed.
license: MIT
metadata:
  version: '2.7.0'
  source: https://github.com/(humanizer-main upstream)
