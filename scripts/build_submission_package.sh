...
#
# Build journal-ready submission artefacts for P3 (JED), P4 (JABES), and
# P5 (IJOEM):
...
build_one "p4_singapore"    "manuscripts/p4_singapore_en_clean.md" "JABES"
...
echo "  P4 -> JABES : $OUT_DIR/p4_singapore_JABES.{docx,tex,pdf}"
